...
trait ScalarConversions {
     ...
     */
    def toScalaSeq[A, B]( c: java.util.Collection[A], f: A => B): Seq[B] = {
        assert(f != null)
     ...
     * @param f Transforming function.
     */
    def toScalaSeq[A, B]( i: java.util.Iterator[A], f: A => B): Seq[B] = {
        assert(f != null)
     ...
     */
    def toScalaSeq[A]( i: java.util.Iterator[A]): Seq[A] =
        toScalaSeq(i, (e: A) => e)
     ...
     * @param f Transforming function.
     */
    def toScalaSeq[A, B]( i: java.lang.Iterable[A], f: A => B): Seq[B] = {
        assert(f != null)
     ...
     */
    def toScalaSeq[A]( i: java.lang.Iterable[A]): Seq[A] =
        toScalaSeq(i, (e: A) => e)
...
//     */
//    def toScalaSeq[A]( c: java.util.Collection[A]): Seq[A] =
//        toScalaSeq(c, (e: A) => e)
     ...
     * @param c Java collection to convert.
     */
    def toScalaItr[K, V]( c: java.util.Collection[java.util.Map.Entry[K, V]]): Iterable[(K, V)] = {
     ...
     * @param f Transforming function.
     */
    def toJavaCollection[A, B]( s: Seq[A], f: A => B): java.util.Collection[B] = {
        assert(f != null)
     ...
     */
    def toJavaCollection[A]( s: Seq[A]): java.util.Collection[A] =
     ...
     * @param f Transforming function.
     */
    def toJavaCollection[A, B]( i: Iterator[A], f: A => B): java.util.Collection[B] = {
        assert(f != null)
