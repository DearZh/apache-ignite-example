...
final class GridUriDeploymentFileProcessor {
     ...
     */
     static GridUriDeploymentFileProcessorResult processFile(File file, String uri, File deployDir,
     ...
     */
     public static String md5( File file,  IgniteLogger log) {
        if (file != null)
     ...
     * @return string representation of the calculated checksum or {@code null} if calculation failed.
     */
     public static String fileMd5( File file,  IgniteLogger log) {
        String md5 = null;
     ...
     * @return string representation of the calculated checksum or {@code null} if calculation failed.
     */
     public static String directoryMd5( File dir,  IgniteLogger log) {
        if (dir != null) {
            if (!dir.isDirectory()) {
     ...
     */
    private static boolean addDirectoryDigest(File file, MessageDigest digest,  IgniteLogger log) {
     ...
     * @return {@code true} if digest was added successfully, {@code false} otherwise.
     */
    private static boolean addFileDigest(File file, MessageDigest digest,  IgniteLogger log) {
        if (!file.isFile()) {
