...
public class IgniteCompatibilityNodeRunner extends IgniteNodeRunner {
     ...
     */
     public static String storeToFile( IgniteInClosure clo) throws IOException {
        if (clo == null)
            return null;
     ...
     * @see #readClosureFromFileAndDelete(String)
     */
    public static void storeToFile(IgniteInClosure clo, String fileName) throws IOException {
