...
public final class DmlAstUtils {
     ...
     */
    public static GridSqlSelect selectForDelete(GridSqlDelete del,  Integer keysParamIdx) {
     ...
     * @return SELECT statement.
     */
    public static GridSqlSelect selectForUpdate(GridSqlUpdate update,  Integer keysParamIdx) {
        GridSqlSelect mapQry = new GridSqlSelect();
