...
public abstract class GridMergeIndex extends BaseIndex {
     ...
     */
    protected abstract Cursor findInStream( SearchRow first,  SearchRow last);
     ...
     * @return Cursor.
     */
    protected abstract Cursor findAllFetched(List<Row> fetched,  SearchRow first,  SearchRow last);
