...
public class VisorValidateIndexesTask extends VisorMultiNodeTask<VisorValidateIndexesTaskArg,
    ...
    /** {@inheritDoc} */
     @Override protected VisorValidateIndexesTaskResult reduce0(List<ComputeJobResult> list) throws IgniteException {
    ...
    private static class VisorValidateIndexesJob extends VisorJob<VisorValidateIndexesTaskArg, VisorValidateIndexesJobResult> {
         ...
         * @param debug Debug.
         */
        protected VisorValidateIndexesJob( VisorValidateIndexesTaskArg arg, boolean debug) {
            super(arg, debug);
        }

        /** {@inheritDoc} */
        @Override protected VisorValidateIndexesJobResult run( VisorValidateIndexesTaskArg arg) throws IgniteException {
            try {
