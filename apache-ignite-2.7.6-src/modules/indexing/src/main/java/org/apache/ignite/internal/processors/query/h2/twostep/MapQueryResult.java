...
class MapQueryResult {
     ...
     */
    MapQueryResult(IgniteH2Indexing h2, ResultSet rs,  GridCacheContext cctx,
        UUID qrySrcNodeId, GridCacheSqlQuery qry, Object[] params,  MapQueryLazyWorker lazyWorker) {
        this.h2 = h2;
        this.cctx = cctx;
        this.qry = qry;
        this.params = params;
