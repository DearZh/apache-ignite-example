...
public class IgniteSqlNotNullConstraintTest extends GridCommonAbstractTest {
    ...
    private static class TestStore extends CacheStoreAdapter<Integer, Person> {
        /** {@inheritDoc} */
        @Override public void loadCache(IgniteBiInClosure<Integer, Person> clo,  Object... args) {
            // No-op
        }
    ...
    private static class TestInterceptor implements CacheInterceptor<Integer, Person> {
        /** {@inheritDoc} */
         @Override public Person onGet(Integer key,  Person val) {
            return null;
        }

        /** {@inheritDoc} */
         @Override public Person onBeforePut(Cache.Entry<Integer, Person> entry, Person newVal) {
            return null;
        }
        ...
        /** {@inheritDoc} */
         @Override public IgniteBiTuple<Boolean, Person> onBeforeRemove(Cache.Entry<Integer, Person> entry) {
            return null;
        }
