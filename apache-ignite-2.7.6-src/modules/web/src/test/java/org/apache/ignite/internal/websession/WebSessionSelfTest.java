...
public class WebSessionSelfTest extends GridCommonAbstractTest {
     ...
     */
    protected WebAppContext getWebContext( String cfg,  String igniteInstanceName,
     ...
     */
    private Server startServer(int port,  String cfg,  String igniteInstanceName, HttpServlet servlet)
        throws Exception {
    ...
    private Server startServerWithLoginService(
        int port,  String cfg,  String igniteInstanceName, HttpServlet servlet
    ) throws Exception {
        Server srv = new Server(port);
     ...
     * @throws Exception In case of error.
     */
    private void stopServer( Server srv) throws Exception {
        if (srv != null)
            srv.stop();
    }
     ...
     * @throws Exception In case of error.
     */
    private void stopServerWithLoginService( Server srv) throws Exception{
        if (srv != null){
            srv.stop();
