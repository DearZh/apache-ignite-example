...
public class IgniteMock implements Ignite {
    ...
    /** {@inheritDoc} */
    @Override public <K, V> IgniteCache<K, V> getOrCreateNearCache( String cacheName, NearCacheConfiguration<K, V> nearCfg) {
        return null;
    }
    ...
    /** {@inheritDoc} */
     @Override public IgniteAtomicLong atomicLong(String name, long initVal, boolean create) {
        return null;
    }
    ...
    /** {@inheritDoc} */
     @Override public IgniteCountDownLatch countDownLatch(String name,
        int cnt,
        boolean autoDel,
        boolean create)
    {
    ...
    /** {@inheritDoc} */
     @Override public IgniteSemaphore semaphore(String name,
        int cnt,
    ...
    /** {@inheritDoc} */
     @Override public IgniteLock reentrantLock(String name,
        boolean failoverSafe,
        boolean fair,
        boolean create)
    {
    ...
    /** {@inheritDoc} */
     @Override public <T> IgniteQueue<T> queue(String name,
        int cap,
    ...
    /** {@inheritDoc} */
     @Override public MemoryMetrics memoryMetrics(String memPlcName) {
