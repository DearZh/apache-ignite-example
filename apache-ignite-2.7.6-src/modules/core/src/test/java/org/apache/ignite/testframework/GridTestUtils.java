...
public final class GridTestUtils {
    ...
    public static final class DiscoverySpiListenerWrapper implements DiscoverySpiListener {
        ...
        /** {@inheritDoc} */
        @Override public IgniteFuture<?> onDiscovery(int type, long topVer, ClusterNode node, Collection<ClusterNode> topSnapshot,  Map<Long, Collection<ClusterNode>> topHist,  DiscoverySpiCustomMessage spiCustomMsg) {
...
//    }
     ...
     */
    public static Throwable assertThrows( IgniteLogger log, Callable<?> call,
        Class<? extends Throwable> cls,  String msg) {
        assert call != null;
        assert cls != null;
     ...
     * @return Thrown throwable.
     */
    public static Throwable assertThrowsAnyCause( IgniteLogger log, Callable<?> call,
        Class<? extends Throwable> cls,  String msg) {
        assert call != null;
        assert cls != null;
     ...
     * @return Thrown throwable.
     */
     public static Throwable assertThrowsInherited( IgniteLogger log, Callable<?> call,
        Class<? extends Throwable> cls,  String msg) {
        assert call != null;
        assert cls != null;
     ...
     */
    private static AssertionError fail(String msg,  Throwable cause) {
     ...
     * @return Thrown throwable.
     */
     public static Throwable assertThrows( IgniteLogger log, Class<? extends Throwable> cls,
         String msg, final Object obj, final String mtd, final Object... params) {
     ...
     */
    private static Collection<String> getFiles(String path,  final String startFilter,
         final String endFilter) throws IOException {
     ...
     * @return Resolved path, or {@code null} if file cannot be resolved.
     */
     private static File resolvePath( String igniteHome, String path) {
    ...
    public static <K, V> void waitTopologyUpdate( String cacheName, int backups, IgniteLogger log)
        throws Exception {
     ...
     */
    public static <T> Callable<T> makeCallable(final Runnable run,  final T res) {
    ...
    public static void retryAssert( IgniteLogger log, int retries, long retryInterval, GridAbsClosure c)
    ...
    public static String keyStorePath(String keyStore) {
     ...
     */
    public static void addTestIfNeeded(final TestSuite suite, final Class<? extends TestCase> test,
         final Collection<Class> ignoredTests) {
