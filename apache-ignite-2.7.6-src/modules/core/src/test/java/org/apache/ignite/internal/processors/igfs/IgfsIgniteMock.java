...
public class IgfsIgniteMock implements IgniteEx {
     ...
     */
    public IgfsIgniteMock( String name, IgniteFileSystem igfs) {
        this.name = name;
        this.igfs = igfs;
    }
    ...
    /** {@inheritDoc} */
    @Override public <T, S> IgniteAtomicStamped<T, S> atomicStamped(String name,  T initVal,
    ...
    /** {@inheritDoc} */
    @Override public <T> IgniteQueue<T> queue(String name, int cap,  CollectionConfiguration cfg)
        throws IgniteException {
        throwUnsupported();
