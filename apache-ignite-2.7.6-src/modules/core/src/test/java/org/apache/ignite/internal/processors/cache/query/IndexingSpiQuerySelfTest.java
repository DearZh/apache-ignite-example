...
public class IndexingSpiQuerySelfTest extends TestCase {
    ...
    private static class MyIndexingSpi extends IgniteSpiAdapter implements IndexingSpi {
        ...
        /** {@inheritDoc} */
        @Override public Iterator<Cache.Entry<?, ?>> query( String cacheName, Collection<Object> params,
        ...
        /** {@inheritDoc} */
        @Override public void store( String cacheName, Object key, Object val, long expirationTime)
        ...
        /** {@inheritDoc} */
        @Override public void remove( String cacheName, Object key) throws IgniteSpiException {
            // No-op.
        }
    }
    ...
    private static class MyBinaryIndexingSpi extends MyIndexingSpi {
        ...
        /** {@inheritDoc} */
        @Override public void store( String cacheName, Object key, Object val,
     ...
     */
     static class PersonKey implements Serializable, Comparable<PersonKey> {
        ...
        /** {@inheritDoc} */
        @Override public int compareTo(PersonKey o) {
