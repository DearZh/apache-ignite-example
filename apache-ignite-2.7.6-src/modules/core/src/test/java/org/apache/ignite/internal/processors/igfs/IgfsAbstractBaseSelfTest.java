...
public abstract class IgfsAbstractBaseSelfTest extends IgfsCommonAbstractTest {
    ...
    protected Ignite startGridWithIgfs(String igniteInstanceName, String igfsName, IgfsMode mode,
         IgfsSecondaryFileSystem secondaryFs,  IgfsIpcEndpointConfiguration restCfg,
    ...
    public static void create(IgfsImpl igfs,  IgfsPath[] dirs,  IgfsPath[] files) throws Exception {
        if (dirs != null) {
     ...
     */
    @SuppressWarnings("EmptyTryBlock")
    public void create(IgfsSecondaryFileSystemTestAdapter uni,  IgfsPath[] dirs,  IgfsPath[] files)
        throws Exception {
        if (dirs != null) {
            for (IgfsPath dir : dirs)
     ...
     */
    protected static void createFile(IgfsEx igfs, IgfsPath file, boolean overwrite,  byte[]... chunks)
        throws IOException {
     ...
     * @throws IOException In case of IO exception.
     */
    protected static void createFile(IgfsSecondaryFileSystemTestAdapter uni, IgfsPath file,  byte[]... chunks)
        throws IOException {
        OutputStream os = null;
     ...
     * @throws Exception If failed.
     */
    protected static void appendFile(IgfsImpl igfs, IgfsPath file,  byte[]... chunks)
        throws Exception {
        IgfsOutputStream os = null;
     ...
     */
    protected static void writeFileChunks(OutputStream os,  byte[]... chunks) throws IOException {
     ...
     * @param file File.
     */
    public static void awaitFileClose( IgfsEx igfs, IgfsPath file) {
        igfs.await(file);
    }
     ...
     * @throws Exception If failed.
     */
    protected void checkFile( IgfsImpl igfs, IgfsSecondaryFileSystemTestAdapter igfsSecondary, IgfsPath file,
         byte[]... chunks) throws Exception {
        if (igfs != null) {
     ...
     */
    protected static void checkFileContent(IgfsImpl igfs, IgfsPath file,  byte[]... chunks)
     ...
     * @throws IgniteCheckedException In case of Grid exception.
     */
    protected void checkFileContent(IgfsSecondaryFileSystemTestAdapter uni, String path,  byte[]... chunks)
        throws IOException, IgniteCheckedException {
        if (chunks != null && chunks.length > 0) {
            InputStream is = null;
     ...
     */
    protected Map<String, String> properties( String grpName,  String perm) {
     ...
     * @return Map with properties.
     */
    protected Map<String, String> properties( String username,  String grpName,
         String perm) {
        Map<String, String> props = new HashMap<>();
