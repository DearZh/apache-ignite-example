...
public class IgfsMock implements IgfsEx {
    ...
    /** {@inheritDoc} */
    @Override public void globalSampling( Boolean val) throws IgniteCheckedException {
        throwUnsupported();
    }
    ...
    @Override public IgfsOutputStream create(IgfsPath path, int bufSize, boolean overwrite, int replication,
        long blockSize,  Map<String, String> props) throws IgniteException {
        throwUnsupported();
    ...
    /** {@inheritDoc} */
    @Override public IgfsOutputStream create(IgfsPath path, int bufSize, boolean overwrite,  IgniteUuid affKey,
        int replication, long blockSize,  Map<String, String> props) throws IgniteException {
        throwUnsupported();
    ...
    /** {@inheritDoc} */
    @Override public <T, R> R execute(Class<? extends IgfsTask<T, R>> taskCls,  IgfsRecordResolver rslvr,
        Collection<IgfsPath> paths,  T arg) throws IgniteException {
        throwUnsupported();
    ...
    /** {@inheritDoc} */
    @Override public void mkdirs(IgfsPath path,  Map<String, String> props) throws IgniteException {
        throwUnsupported();
    }
