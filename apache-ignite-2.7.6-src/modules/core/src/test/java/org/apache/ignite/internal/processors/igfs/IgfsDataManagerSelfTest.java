...
public class IgfsDataManagerSelfTest extends IgfsCommonAbstractTest {
     ...
     */
    private void expectsStoreFail(final IgfsEntryInfo reserved, final byte[] data,  String msg) {
     ...
     * @param msg Expected failure message.
     */
    private void expectsDeleteFail(final IgfsEntryInfo fileInfo,  String msg) {
        GridTestUtils.assertThrows(log, new Callable() {
            @Override public Object call() throws Exception {
                mgr.delete(fileInfo);
