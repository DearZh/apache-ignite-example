...
public class IgniteDynamicClientCacheStartSelfTest extends GridCommonAbstractTest {
     ...
     * @throws Exception If failed.
     */
    private void startMultipleClientCaches( String grp) throws Exception {
        final int SRVS = 1;
     ...
     */
    private List<CacheConfiguration> cacheConfigurations( String grp, CacheAtomicityMode atomicityMode) {
