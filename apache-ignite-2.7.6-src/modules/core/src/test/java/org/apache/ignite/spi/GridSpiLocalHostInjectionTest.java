...
public class GridSpiLocalHostInjectionTest extends GridCommonAbstractTest {
     ...
     * @throws IgniteCheckedException If test fails.
     */
    private void processTcpDiscoverySpiTestInjection(boolean cfgVal, boolean spiVal,  String exp)
     ...
     * @throws IgniteCheckedException If test fails.
     */
    private void processTcpCommunicationSpiTestInjection(boolean cfgVal, boolean spiVal,  String exp)
        throws IgniteCheckedException {
        GridResourceProcessor proc = getResourceProcessor(cfgVal);
