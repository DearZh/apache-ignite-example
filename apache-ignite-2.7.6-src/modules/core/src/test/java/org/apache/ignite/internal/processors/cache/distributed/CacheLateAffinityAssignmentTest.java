...
public class CacheLateAffinityAssignmentTest extends GridCommonAbstractTest {
     ...
     */
    protected AffinityFunction affinityFunction( Integer parts) {
    ...
    private boolean calculateAffinity(long topVer,
        boolean filterByRcvd,
         Map<String, List<List<ClusterNode>>> cur) throws Exception {
     ...
     */
     private List<List<ClusterNode>> previousAssignment(long topVer, Integer cacheId) {
        if (topVer == 1)
            return null;
