...
public class GridStringLogger implements IgniteLogger {
     ...
     */
    public GridStringLogger(boolean dbg,  IgniteLogger echo) {
        this.dbg = dbg;
        this.echo = echo;
    }
    ...
    /** {@inheritDoc} */
    @Override public synchronized void warning(String msg,  Throwable e) {
        log(msg);
    ...
    /** {@inheritDoc} */
    @Override public synchronized void error(String msg,  Throwable e) {
        log(msg);
