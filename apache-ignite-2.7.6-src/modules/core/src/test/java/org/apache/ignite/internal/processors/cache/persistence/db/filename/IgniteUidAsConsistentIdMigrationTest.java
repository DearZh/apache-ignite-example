...
public class IgniteUidAsConsistentIdMigrationTest extends GridCommonAbstractTest {
     ...
     * @throws Exception If failed.
     */
    private Ignite startActivateFillDataGrid(int idx) throws Exception {
     ...
     */
    private Ignite startActivateGrid(int idx) throws Exception {
     ...
     */
    private String genNewStyleSubfolderName(final int nodeIdx, final Ignite ignite) {
