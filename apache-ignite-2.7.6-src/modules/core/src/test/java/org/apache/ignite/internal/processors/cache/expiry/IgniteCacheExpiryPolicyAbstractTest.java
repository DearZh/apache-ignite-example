...
public abstract class IgniteCacheExpiryPolicyAbstractTest extends IgniteCacheAbstractTest {
     ...
     * @throws Exception If failed.
     */
    private void createUpdatePutAll( TransactionConcurrency txConcurrency) throws Exception {
        Map<Integer, Integer> vals = new HashMap<>();
     ...
     * @throws Exception If failed.
     */
    private void createUpdateCustomPolicy(Integer key,  TransactionConcurrency txConcurrency)
        throws Exception {
        IgniteCache<Integer, Integer> cache = jcache();
     ...
     * @throws Exception If failed.
     */
    private void createUpdate(Integer key,  TransactionConcurrency txConcurrency)
        throws Exception {
        IgniteCache<Integer, Integer> cache = jcache();
