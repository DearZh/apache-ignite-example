...
public class GridCacheLoadOnlyStoreAdapterSelfTest extends GridCacheAbstractSelfTest {
    ...
    private static class TestStore extends CacheLoadOnlyStoreAdapter<Integer, String, String> {
        ...
        /** {@inheritDoc} */
        @Override protected Iterator<String> inputIterator( Object... args) {
            assertNotNull(args);
        ...
        /** {@inheritDoc} */
        @Override protected IgniteBiTuple<Integer, String> parse(String rec,  Object... args) {
            assertNotNull(args);
            assertTrue(Arrays.equals(EXP_ARGS, args));
    ...
    private static class ParallelTestStore extends CacheLoadOnlyStoreAdapter<Integer, String, String> {
        ...
        /** {@inheritDoc} */
        @Override protected Iterator<String> inputIterator( Object... args) throws CacheLoaderException {
            return new Iterator<String>() {
                private int i;
