...
public class GridLoadTestArgs {
     ...
     *         both JVM property and environment variable are not set.
     */
     private static String getStringProperty0(String name) {
     ...
     *         are {@code null}.
     */
     private static Integer getIntProperty0(String name) {
     ...
     *         both JVM property and environment variable are not set.
     */
     private static Long getLongProperty0(String name) {
     ...
     */
     private static <T> T saveProperty(String name,  T val) {
