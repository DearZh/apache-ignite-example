...
public class GridCacheTestEntryEx extends GridMetadataAwareAdapter implements GridCacheEntryEx {
    ...
    /** {@inheritDoc} */
     @Override public EvictableEntry wrapEviction() {
        return null;
    }
     ...
     */
     GridCacheMvccCandidate addLocal(
        long threadId,
    ...
    /** {@inheritDoc} */
     @Override public List<GridCacheEntryInfo> allVersionsInfo()
    ...
    @Override public boolean evictInternal(GridCacheVersion obsoleteVer,
         CacheEntryPredicate[] filter, boolean evictOffheap) {
        assert false;
    ...
    @Override public EntryGetResult innerGetAndReserveForLoad(
        ...
        boolean keepBinary,
        MvccSnapshot mvccVer,
         ReaderArguments args) throws IgniteCheckedException, GridCacheEntryRemovedException {
        assert false;
    ...
    /** @inheritDoc */
    @Override public GridCacheUpdateTxResult innerSet( IgniteInternalTx tx,
        UUID evtNodeId,
        UUID affNodeId,
         CacheObject val,
    ...
    /** {@inheritDoc} */
    @Override public GridCacheUpdateTxResult mvccSet( IgniteInternalTx tx, UUID affNodeId, CacheObject val,
    ...
    /** {@inheritDoc} */
    @Override public GridCacheUpdateTxResult mvccRemove( IgniteInternalTx tx, UUID affNodeId,
    ...
    /** {@inheritDoc} */
     @Override public CacheObject peek(boolean heap,
        boolean offheap,
        AffinityTopologyVersion topVer,
