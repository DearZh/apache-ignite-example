...
public abstract class GridCacheAbstractFailoverSelfTest extends GridCacheAbstractSelfTest {
     ...
     * @throws Exception If failed.
     */
    protected void testTopologyChange( TransactionConcurrency concurrency,
     ...
     * @throws Exception If failed.
     */
    protected void testConstantTopologyChange( final TransactionConcurrency concurrency,
