...
public abstract class IgfsServerManagerIpcEndpointRegistrationAbstractSelfTest extends IgfsCommonAbstractTest {
     ...
     */
    protected FileSystemConfiguration igfsConfiguration( IgfsIpcEndpointType endPntType,
         Integer endPntPort,  String endPntHost) throws IgniteCheckedException {
     ...
     */
    protected FileSystemConfiguration igfsConfiguration( IgfsIpcEndpointType endPntType,
         Integer endPntPort,  String endPntHost, String dataCacheName, String metaCacheName) throws IgniteCheckedException {
