...
public class IgniteWalReaderTest extends GridCommonAbstractTest {
     ...
     */
    private String genDbSubfolderName(Ignite ignite, int nodeIdx) {
    ...
    private void scanIterateAndCount(
        ...
        int minCntEntries,
        int minTxCnt,
         IgniteBiInClosure<Object, Object> objConsumer,
         IgniteInClosure<DataRecord> dataRecordHnd
     ...
     * @throws IgniteCheckedException If failed.
     */
    private IteratorParametersBuilder createIteratorParametersBuilder(
        String workDir,
    ...
    private Map<GridCacheVersion, Integer> iterateAndCountDataRecord(
        WALIterator walIter,
         IgniteBiInClosure<Object, Object> cacheObjHnd,
         IgniteInClosure<DataRecord> dataRecordHnd
    ) throws IgniteCheckedException {
