...
public class GridAffinityProcessor extends GridProcessorAdapter {
     ...
     * @throws IgniteCheckedException If failed.
     */
    public int partition(String cacheName, Object key,  AffinityInfo aff) throws IgniteCheckedException {
     ...
     * @throws IgniteCheckedException If failed.
     */
    public int partition0(String cacheName, Object key,  AffinityInfo aff) throws IgniteCheckedException {
        assert cacheName != null;
     ...
     * @throws IgniteCheckedException If failed.
     */
     public ClusterNode mapPartitionToNode(String cacheName, int partId, AffinityTopologyVersion topVer)
     ...
     * @throws IgniteCheckedException If failed.
     */
    public <K> Map<ClusterNode, Collection<K>> mapKeysToNodes(String cacheName,  Collection<? extends K> keys)
        throws IgniteCheckedException {
        assert cacheName != null;
     ...
     * @throws IgniteCheckedException If failed.
     */
     public <K> ClusterNode mapKeyToNode(String cacheName, K key, AffinityTopologyVersion topVer)
        throws IgniteCheckedException {
        assert cacheName != null;
    ...
    @SuppressWarnings("unchecked")
     public Object affinityKey(String cacheName,  Object key) throws IgniteCheckedException {
        assert cacheName != null;
     ...
     * @throws IgniteCheckedException If failed.
     */
    private <K> Map<ClusterNode, Collection<K>> keysToNodes( final String cacheName,
    ...
    @SuppressWarnings("ErrorNotRethrown")
     private AffinityInfo affinityCache(final String cacheName, AffinityTopologyVersion topVer)
        throws IgniteCheckedException {
    ...
    private static class AffinityAssignmentKey implements Comparable<AffinityAssignmentKey> {
         ...
         * @param topVer Topology version.
         */
        private AffinityAssignmentKey(String cacheName, AffinityTopologyVersion topVer) {
         ...
         * @param topVer Topology version.
         */
        private AffinityAssignmentKey(AffinityTopologyVersion topVer) {
            this.topVer = topVer;
        }
    ...
    private class CacheAffinityProxy<K> implements Affinity<K> {
        ...
        /** {@inheritDoc} */
         @Override public ClusterNode mapKeyToNode(K key) {
            A.notNull(key, "key");
