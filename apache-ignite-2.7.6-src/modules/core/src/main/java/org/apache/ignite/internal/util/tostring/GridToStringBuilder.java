...
public class GridToStringBuilder {
     ...
     * @return String presentation of the given object.
     */
    public static <T> String toString(Class<T> cls, T obj, String name,  Object val, boolean sens) {
        assert cls != null;
        assert obj != null;
        assert name != null;
     ...
     */
    public static String toString(String str, String name,  Object val) {
     ...
     * @return String presentation.
     */
    public static String toString(String str, String name,  Object val, boolean sens) {
        assert name != null;
     ...
     * @return String presentation.
     */
    public static String toString(String str, String name0,  Object val0, String name1,
         Object val1) {
