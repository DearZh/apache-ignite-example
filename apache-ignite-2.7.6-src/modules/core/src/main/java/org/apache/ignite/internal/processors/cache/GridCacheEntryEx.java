...
public interface GridCacheEntryEx {
     ...
     */
    public boolean evictInternal(GridCacheVersion obsoleteVer,  CacheEntryPredicate[] filter,
     ...
     * @throws GridCacheEntryRemovedException If entry was removed.
     */
     public CacheObject innerGet( GridCacheVersion ver,
         IgniteInternalTx tx,
        boolean readThrough,
     ...
     */
     public CacheObject innerReload() throws IgniteCheckedException, GridCacheEntryRemovedException;
     ...
     * @throws IgniteCheckedException If failed.
     */
    public boolean markObsoleteIfEmpty( GridCacheVersion ver) throws IgniteCheckedException;
     ...
     * @throws IgniteCheckedException If failed.
     */
     public CacheObject peek(boolean heap,
        boolean offheap,
        AffinityTopologyVersion topVer,
     ...
     * @throws IgniteCheckedException If failed.
     */
     public CacheObject peek( IgniteCacheExpiryPolicy plc)
        throws GridCacheEntryRemovedException, IgniteCheckedException;
     ...
     * @throws GridCacheEntryRemovedException If entry was removed.
     */
    public Collection<GridCacheMvccCandidate> localCandidates( GridCacheVersion... exclude)
        throws GridCacheEntryRemovedException;
     ...
     * @throws GridCacheEntryRemovedException If entry was removed.
     */
     public GridCacheMvccCandidate candidate(UUID nodeId, long threadId)
        throws GridCacheEntryRemovedException;
     ...
     * @throws GridCacheEntryRemovedException If entry was removed.
     */
     public CacheObject valueBytes( GridCacheVersion ver)
        throws IgniteCheckedException, GridCacheEntryRemovedException;
     ...
     * @param ttl Time to live.
     */
    public void updateTtl( GridCacheVersion ver, long ttl) throws GridCacheEntryRemovedException;
     ...
     * @throws GridCacheEntryRemovedException If entry was removed.
     */
     public CacheObject unswap(CacheDataRow row)
        throws IgniteCheckedException, GridCacheEntryRemovedException;
     ...
     * @throws GridCacheEntryRemovedException If entry was removed.
     */
     public CacheObject unswap(boolean needVal)
        throws IgniteCheckedException, GridCacheEntryRemovedException;
