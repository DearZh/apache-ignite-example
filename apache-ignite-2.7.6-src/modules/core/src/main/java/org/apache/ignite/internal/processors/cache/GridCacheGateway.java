...
public class GridCacheGateway<K, V> {
     ...
     */
     public CacheOperationContext enter( CacheOperationContext opCtx) {
        try {
     ...
     * @return Previous operation context set on this thread.
     */
     public CacheOperationContext enterNoLock( CacheOperationContext opCtx) {
        onEnter(opCtx);
     ...
     * @return Previous operation context set on this thread.
     */
    private CacheOperationContext setOperationContextPerCall( CacheOperationContext opCtx) {
