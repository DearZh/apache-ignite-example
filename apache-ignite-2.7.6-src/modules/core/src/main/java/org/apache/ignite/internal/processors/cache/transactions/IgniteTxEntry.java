...
public class IgniteTxEntry implements GridPeerDeployAware, Message {
     ...
     */
    public void value( CacheObject val, boolean writeVal, boolean readVal) {
     ...
     */
    public void readValue( CacheObject val) {
     ...
     */
    public void conflictVersion( GridCacheVersion conflictVer) {
        this.conflictVer = conflictVer;
    }
     ...
     */
    public void expiry( ExpiryPolicy expiryPlc) {
