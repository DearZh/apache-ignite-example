...
public class VisorWalTask extends VisorMultiNodeTask<VisorWalTaskArg, VisorWalTaskResult, Collection<String>> {
    ...
    /** {@inheritDoc} */
     @Override protected VisorWalTaskResult reduce0(List<ComputeJobResult> results) throws IgniteException {
    ...
    private static class VisorWalJob extends VisorJob<VisorWalTaskArg, Collection<String>> {
        ...
        /** {@inheritDoc} */
         @Override protected Collection<String> run( VisorWalTaskArg arg) throws IgniteException {
            try {
