...
public class GridCacheExplicitLockSpan extends ReentrantLock {
     ...
     */
    public GridCacheMvccCandidate removeCandidate(IgniteTxKey key,  GridCacheVersion ver) {
        lock();
     ...
     */
     public GridCacheMvccCandidate candidate(IgniteTxKey key,  final GridCacheVersion ver) {
        lock();
