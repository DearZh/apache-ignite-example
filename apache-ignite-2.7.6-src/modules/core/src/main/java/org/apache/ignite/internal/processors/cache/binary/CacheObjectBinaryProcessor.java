...
public interface CacheObjectBinaryProcessor extends IgniteCacheObjectProcessor {
     ...
     * @throws IgniteException In case of error.
     */
    public void updateMetadata(int typeId, String typeName,  String affKeyFieldName,
     ...
     * @throws IgniteException In case of error.
     */
     public BinaryType metadata(int typeId) throws IgniteException;
     ...
     * @throws IgniteException In case of error.
     */
     public BinaryType metadata(int typeId, int schemaId) throws IgniteException;
