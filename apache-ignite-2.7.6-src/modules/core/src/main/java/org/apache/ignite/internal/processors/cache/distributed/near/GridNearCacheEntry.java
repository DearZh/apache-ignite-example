...
public class GridNearCacheEntry extends GridDistributedCacheEntry {
    ...
    public boolean loadedValue( IgniteInternalTx tx,
        UUID primaryNodeId,
        CacheObject val,
        GridCacheVersion ver,
        GridCacheVersion dhtVer,
    ...
    /** {@inheritDoc} */
     @Override public CacheDataRow unswap(CacheDataRow row, boolean checkExpire) {
        return null;
    }
     ...
     * @throws GridCacheEntryRemovedException If entry has been removed.
     */
     GridCacheMvccCandidate addNearLocal(
         UUID dhtNodeId,
        long threadId,
        GridCacheVersion ver,
        AffinityTopologyVersion topVer,
     ...
     */
     public GridCacheMvccCandidate dhtNodeId(GridCacheVersion ver, UUID dhtNodeId)
        throws GridCacheEntryRemovedException {
        lockEntry();
