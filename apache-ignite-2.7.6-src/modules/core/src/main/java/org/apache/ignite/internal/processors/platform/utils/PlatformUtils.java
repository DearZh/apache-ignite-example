...
public class PlatformUtils {
     ...
     */
    public static <T> void writeNullableCollection(BinaryRawWriterEx writer,  Collection<T> col) {
     ...
     */
    public static <T> void writeNullableCollection(BinaryRawWriterEx writer,  Collection<T> col,
         PlatformWriterClosure<T> writeClo,  IgnitePredicate<T> filter) {
        if (col != null) {
     ...
     */
    public static <K, V> void writeNullableMap(BinaryRawWriterEx writer,  Map<K, V> map) {
        if (map != null) {
            writer.writeBoolean(true);
     ...
     * @return List.
     */
    public static <T> List<T> readCollection(BinaryRawReaderEx reader,  PlatformReaderClosure<T> readClo) {
     ...
     */
    public static void writeErrorData(Throwable err, BinaryRawWriterEx writer,  IgniteLogger log) {
     ...
     */
    public static void initializeJavaObject(Object obj, String clsName,  Map<String, Object> props,
