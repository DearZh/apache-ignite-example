...
public class GridResourceProcessor extends GridProcessorAdapter {
     ...
     */
    public void setSpringContext( GridSpringResourceContext rsrcCtx) {
     ...
     * @throws IgniteCheckedException If failed to inject.
     */
    private boolean inject(Object obj, GridResourceIoc.ResourceAnnotation ann,  GridDeployment dep,
         Class<?> depCls, Object param)
        throws IgniteCheckedException {
        GridResourceIoc.ClassDescriptor clsDesc = ioc.descriptor(null, obj.getClass());
