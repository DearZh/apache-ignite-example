...
public class GridNioServer<T> {
    ...
    public IgniteInternalFuture<String> dumpStats(final String msg, IgnitePredicate<GridNioSession> p) {
        GridCompoundFuture<String, String> fut = new GridCompoundFuture<>(new IgniteReducer<String, String>() {
            ...
            @Override public boolean collect( String msg) {
                if (!F.isEmpty(msg)) {
                    synchronized (sb) {
                        if (sb.length() > 0)
                            sb.append(U.nl());
     ...
     */
    private Selector createSelector( SocketAddress addr) throws IgniteCheckedException {
     ...
     */
    private synchronized void offerBalanced(NioOperationFuture req,  Map<Integer, Object> meta) {
    ...
    private abstract class AbstractNioClientWorker extends GridWorker implements GridNioWorker {
         ...
         */
        protected boolean close(final GridSelectorNioSessionImpl ses,  final IgniteCheckedException e) {
            if (e != null) {
    ...
    public static class Builder<T> {
         ...
         * @return This for chaining.
         */
        public Builder<T> serverName( String srvName) {
