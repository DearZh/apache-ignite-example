...
public abstract class GridDhtAtomicAbstractUpdateRequest extends GridCacheIdMessage implements GridCacheDeployable {
     ...
     * @return Value.
     */
     public abstract CacheObject previousValue(int idx);
     ...
     * @return Value.
     */
     public abstract CacheObject nearValue(int idx);

    /**
     * @param idx Key index.
     * @return Transform closure.
     */
     public abstract EntryProcessor<Object, Object, Object> nearEntryProcessor(int idx);

    /**
     * @param idx Index.
     * @return Conflict version.
     */
     public abstract GridCacheVersion conflictVersion(int idx);
