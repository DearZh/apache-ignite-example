...
public class IgniteSQLException extends IgniteException {
     ...
     * @param cause Cause to throw this exception.
     */
    public IgniteSQLException(String msg,  Throwable cause) {
     ...
     * @see IgniteQueryErrorCode
     */
    public IgniteSQLException(String msg, int statusCode,  Throwable cause) {
     ...
     * @see IgniteQueryErrorCode
     */
    private IgniteSQLException(String msg, int statusCode, String sqlState,  Throwable cause) {
        super(msg, cause);
