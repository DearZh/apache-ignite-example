...
public class GridDhtAtomicCache<K, V> extends GridDhtCacheAdapter<K, V> {
    ...
    /** {@inheritDoc} */
    @Override protected V getAndPut0(K key, V val,  CacheEntryPredicate filter) throws IgniteCheckedException {
        return (V)update0(
            key,
            val,
            null,
    ...
    @Override public IgniteInternalFuture<V> getAndPutAsync0(K key, V val,  CacheEntryPredicate filter) {
        return update0(
            key,
            val,
            null,
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
    @Override public IgniteInternalFuture<Boolean> putAsync0(K key, V val,  CacheEntryPredicate filter) {
        return update0(
            key,
            val,
            null,
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
    @Override public IgniteInternalFuture<Boolean> removeAsync0(K key,  CacheEntryPredicate filter) {
    ...
    private IgniteInternalFuture updateAll0(
         ...
         Map<? extends K, ? extends EntryProcessor> invokeMap,
         Object[] invokeArgs,
         Map<KeyCacheObject, GridCacheDrInfo> conflictPutMap,
         Map<KeyCacheObject, GridCacheVersion> conflictRmvMap,
    ...
    private IgniteInternalFuture removeAllAsync0(
         ...
         Map<KeyCacheObject, GridCacheVersion> conflictMap,
        final boolean retval,
        boolean rawRetval,
        boolean async
    ) {
     ...
     * @return Get future.
     */
    private IgniteInternalFuture<Map<K, V>> getAllAsync0( Collection<KeyCacheObject> keys,
        boolean forcePrimary,
        UUID subjId,
        String taskName,
        boolean deserializeBinary,
    ...
    @SuppressWarnings("ForLoopReplaceableByForEach")
     private void updatePartialBatch(
        ...
        final ClusterNode nearNode,
         ...
         final Map<KeyCacheObject, CacheObject> putMap,
         final Collection<KeyCacheObject> rmvKeys,
         final Map<KeyCacheObject, EntryProcessor<Object, Object, Object>> entryProcessorMap,
        final GridNearAtomicAbstractUpdateRequest req,
        final GridNearAtomicUpdateResponse res,
        final boolean replicate,
        final DhtAtomicUpdateResult dhtUpdRes,
