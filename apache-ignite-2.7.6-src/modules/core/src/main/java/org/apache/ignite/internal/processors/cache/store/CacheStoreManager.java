...
public interface CacheStoreManager extends GridCacheManager {
     ...
     */
    public void initialize( CacheStore<?, ?> cfgStore, Map<CacheStore, ThreadLocal> sesHolders)
     ...
     */
     public Object load( IgniteInternalTx tx, KeyCacheObject key) throws IgniteCheckedException;
     ...
     * @throws IgniteCheckedException If data loading failed.
     */
    public boolean loadAll( IgniteInternalTx tx, Collection<? extends KeyCacheObject> keys,
     ...
     * @throws IgniteCheckedException If data loading failed.
     */
    public void localStoreLoadAll( IgniteInternalTx tx, Collection<? extends KeyCacheObject> keys,
     ...
     */
    public boolean put( IgniteInternalTx tx, KeyCacheObject key, CacheObject val, GridCacheVersion ver)
        throws IgniteCheckedException;
     ...
     * @throws IgniteCheckedException If storage failed.
     */
    public boolean remove( IgniteInternalTx tx, KeyCacheObject key) throws IgniteCheckedException;
     ...
     * @throws IgniteCheckedException If storage failed.
     */
    public boolean removeAll( IgniteInternalTx tx, Collection<? extends KeyCacheObject> keys)
        throws IgniteCheckedException;
