...
public class GridOffHeapProcessor extends GridProcessorAdapter {
     ...
     */
    public void create( String spaceName, int parts, long init, long max,
     ...
     * @param spaceName Space name.
     * */
    public void destruct( String spaceName) {
        spaceName = maskNull(spaceName);
    ...
    @SuppressWarnings("unchecked")
     private GridOffHeapPartitionedMap offheap( String spaceName) {
     ...
     */
    private byte[] keyBytes(KeyCacheObject key,  byte[] keyBytes) throws IgniteCheckedException {
        assert key != null;
     ...
     * @throws IgniteCheckedException If failed.
     */
    public boolean contains( String spaceName, int part, KeyCacheObject key, byte[] keyBytes)
     ...
     * @throws IgniteCheckedException If failed.
     */
     public byte[] get( String spaceName, int part, KeyCacheObject key, byte[] keyBytes)
        throws IgniteCheckedException {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @throws IgniteCheckedException If failed.
     */
     public IgniteBiTuple<Long, Integer> valuePointer( String spaceName, int part, KeyCacheObject key,
     ...
     * @throws IgniteCheckedException If failed.
     */
    public void enableEviction( String spaceName, int part, KeyCacheObject key, byte[] keyBytes)
        throws IgniteCheckedException {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @throws IgniteCheckedException If failed.
     */
     public <T> T getValue( String spaceName, int part, KeyCacheObject key, byte[] keyBytes,
     ...
     * @throws IgniteCheckedException If failed.
     */
     public byte[] remove( String spaceName, int part, KeyCacheObject key, byte[] keyBytes) throws IgniteCheckedException {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @throws IgniteCheckedException If failed.
     */
    public void put( String spaceName, int part, KeyCacheObject key, byte[] keyBytes, byte[] valBytes)
        throws IgniteCheckedException {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @throws IgniteCheckedException If failed.
     */
    public boolean removex( String spaceName, int part, KeyCacheObject key, byte[] keyBytes)
        throws IgniteCheckedException {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @throws IgniteCheckedException If failed.
     */
    public boolean removex( String spaceName,
        int part,
        KeyCacheObject key,
        byte[] keyBytes,
     ...
     * @return Iterator.
     */
    public GridCloseableIterator<IgniteBiTuple<byte[], byte[]>> iterator( String spaceName) {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @return Iterator.
     */
    public <T> GridCloseableIterator<T> iterator( String spaceName,
     ...
     */
    public long entriesCount( String spaceName) {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @return Number of elements or {@code -1} if no space with the given name has been found.
     */
    public long entriesCount( String spaceName, Set<Integer> parts) {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     */
    public long allocatedSize( String spaceName) {
        GridOffHeapPartitionedMap m = offheap(spaceName);
     ...
     * @return Iterator.
     */
    public GridCloseableIterator<IgniteBiTuple<byte[], byte[]>> iterator( String spaceName, int part) {
        GridOffHeapPartitionedMap m = offheap(spaceName);
