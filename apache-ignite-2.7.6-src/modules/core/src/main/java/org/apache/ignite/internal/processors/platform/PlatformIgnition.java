...
public class PlatformIgnition {
     ...
     */
    public static synchronized void start( String springCfgPath,
         String igniteInstanceName, int factoryId, long envPtr, long dataPtr) {
        if (envPtr <= 0)
     ...
     */
     public static synchronized PlatformProcessor instance( String igniteInstanceName) {
     ...
     */
    public static synchronized long environmentPointer( String igniteInstanceName) {
     ...
     */
    public static synchronized boolean stop( String igniteInstanceName, boolean cancel) {
