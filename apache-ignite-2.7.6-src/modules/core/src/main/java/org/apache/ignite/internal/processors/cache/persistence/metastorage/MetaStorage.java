...
public class MetaStorage implements DbCheckpointListener, ReadOnlyMetastorage, ReadWriteMetastorage {
    ...
    /** {@inheritDoc} */
    @Override public void write(String key, Serializable val) throws IgniteCheckedException {
        assert val != null;
    ...
    /** {@inheritDoc} */
    @Override public void remove(String key) throws IgniteCheckedException {
        removeData(key);
    }
