...
public class MvccUtils {
     ...
     * @return Currently started user transaction, or {@code null} if none started.
     */
     public static GridNearTxLocal tx(GridKernalContext ctx,  GridCacheVersion txId) {
     ...
     * @return Newly started SQL transaction.
     */
    private static GridNearTxLocal txStart(GridKernalContext ctx,  GridCacheContext cctx, long timeout) {
        if (timeout == 0) {
     ...
     * @throws IgniteCheckedException If failed.
     */
    public static MvccQueryTracker mvccTracker(GridCacheContext cctx, boolean startTx) throws IgniteCheckedException {
     ...
     * @throws IgniteCheckedException If failed.
     */
    public static MvccQueryTracker mvccTracker(GridCacheContext cctx,
