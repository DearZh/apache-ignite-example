...
public class GridNearTxLocal extends GridDhtTxLocalAdapter implements GridTimeoutObject, AutoCloseable {
    ...
    /** {@inheritDoc} */
    @Override protected void sendFinishReply( Throwable err) {
    ...
    private <K, V> IgniteInternalFuture mvccPutAllAsync0(
        final GridCacheContext cacheCtx,
         Map<? extends K, ? extends V> map,
         Map<? extends K, ? extends EntryProcessor<K, V, Object>> invokeMap,
         final Object[] invokeArgs,
        final boolean retval,
         final CacheEntryPredicate filter
    ) {
    ...
    private <K, V> IgniteInternalFuture<Void> enlistWrite(
        ...
        Collection<?> keys,
         ExpiryPolicy expiryPlc,
         Map<?, ?> lookup,
         Map<?, EntryProcessor<K, V, Object>> invokeMap,
         Object[] invokeArgs,
        final boolean retval,
        boolean lockOnly,
        final CacheEntryPredicate[] filter,
    ...
    private boolean enlistWriteEntry(GridCacheContext cacheCtx,
        ...
        long drExpireTime,
        final GridCacheReturn ret,
         final Collection<KeyCacheObject> enlisted,
        boolean skipStore,
        boolean singleRmv,
        boolean hasFilters,
    ...
    public <K, V> IgniteInternalFuture<Map<K, V>> getAllAsync(
        final GridCacheContext cacheCtx,
         final AffinityTopologyVersion entryTopVer,
     ...
     * @param maps Mappings.
     */
    void addEntryMapping( Collection<GridDistributedTxMapping> maps) {
        if (!F.isEmpty(maps)) {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
     @Override public IgniteInternalFuture<?> currentPrepareFuture() {
        return prepFut;
    }
