...
public class GridResourceIoc {
     ...
     * @return Descriptor.
     */
    ClassDescriptor descriptor( GridDeployment dep, Class<?> cls) {
        Map<Class<?>, ClassDescriptor> newMap, oldMap;
     ...
     */
    boolean isAnnotationPresent(Object target, Class<? extends Annotation> annCls,  GridDeployment dep) {
        assert target != null;
        assert annCls != null;
     ...
     */
    boolean isAnnotationsPresent( GridDeployment dep, Object target, AnnotationSet annSet) {
        assert target != null;
        assert annSet != null;
     ...
     */
    GridResourceMethod[] getMethodsWithAnnotation( GridDeployment dep, Class<?> cls,
        Class<? extends Annotation> annCls) {
