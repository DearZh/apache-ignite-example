...
public abstract class AbstractWalRecordsIterator
    ...
    protected AbstractWalRecordsIterator(
        ...
        final GridCacheSharedContext sharedCtx,
        final RecordSerializerFactory serializerFactory,
        final FileIOFactory ioFactory,
    ...
    protected abstract AbstractReadFileHandle advanceSegment(
         final AbstractReadFileHandle curWalSegment
    ...
    protected IgniteBiTuple<WALPointer, WALRecord> advanceRecord(
         final AbstractReadFileHandle hnd
    ) throws IgniteCheckedException {
        if (hnd == null)
            return null;
     ...
     */
    protected WALRecord postProcessRecord(final WALRecord rec) {
        return rec;
    }
    ...
    protected AbstractReadFileHandle initReadHandle(
        final AbstractFileDescriptor desc,
         final FileWALPointer start,
        final SegmentIO fileIO,
