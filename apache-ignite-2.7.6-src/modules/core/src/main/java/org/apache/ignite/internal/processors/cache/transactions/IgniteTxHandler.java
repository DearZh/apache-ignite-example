...
public class IgniteTxHandler {
     ...
     */
    private IgniteTxEntry unmarshal( Collection<IgniteTxEntry> entries) throws IgniteCheckedException {
        if (entries == null)
            return null;
     ...
     */
    private void sendResponseOnTimeoutOrError( IgniteCheckedException e,
     ...
     * @return Future.
     */
     private IgniteInternalFuture<IgniteInternalTx> processNearTxFinishRequest(
        UUID nodeId,
     ...
     * @return Future.
     */
     public IgniteInternalFuture<IgniteInternalTx> finish(UUID nodeId,
     ...
     * @throws IgniteCheckedException If failed.
     */
     private GridNearTxRemote startNearRemoteTx(ClassLoader ldr, UUID nodeId,
