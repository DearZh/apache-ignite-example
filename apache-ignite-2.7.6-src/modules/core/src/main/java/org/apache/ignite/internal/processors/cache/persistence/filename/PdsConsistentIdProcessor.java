...
public class PdsConsistentIdProcessor extends GridProcessorAdapter implements PdsFoldersResolver {
     ...
     */
    private String getPathDisplayableInfo(final File folder) {
        final SB res = new SB();
     ...
     */
    private PdsFolderSettings generateAndLockNewDbStorage(final File pstStoreBasePath,
     ...
     */
    public static String genNewStyleSubfolderName(final int nodeIdx, final UUID uuid) {
     ...
     * @throws IgniteCheckedException if failed
     */
    private GridCacheDatabaseSharedManager.FileLockHolder lockRootDirectory(File pstStoreBasePath)
     ...
     */
    private FolderCandidate parseFileName(final File subFolderFile) {
     ...
     * @return Pair of UUID and node index.
     */
     public static FolderCandidate parseSubFolderName(
        final File subFolderFile,
