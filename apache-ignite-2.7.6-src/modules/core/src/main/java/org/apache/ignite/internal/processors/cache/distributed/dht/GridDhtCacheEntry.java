...
public class GridDhtCacheEntry extends GridDistributedCacheEntry {
     ...
     */
     GridCacheMvccCandidate localCandidateByNearVersion(
     ...
     */
     GridCacheMvccCandidate addDhtLocal(
        UUID nearNodeId,
        GridCacheVersion nearVer,
        AffinityTopologyVersion topVer,
        long threadId,
    ...
    @SuppressWarnings({"NonPrivateFieldAccessedInSynchronizedContext"})
     public IgniteBiTuple<GridCacheVersion, CacheObject> versionedValue(
        AffinityTopologyVersion topVer)
        throws GridCacheEntryRemovedException {
        lockEntry();
    ...
    @SuppressWarnings("unchecked")
     public IgniteInternalFuture<Boolean> addReader(UUID nodeId, long msgId, AffinityTopologyVersion topVer)
        throws GridCacheEntryRemovedException {
     ...
     * @throws GridCacheEntryRemovedException If removed.
     */
     public GridCacheMvccCandidate mappings(
        GridCacheVersion ver,
    ...
    public static class ReaderId {
         ...
         */
        public static boolean contains( ReaderId[] readers, UUID nodeId) {
            if (readers == null)
                return false;
