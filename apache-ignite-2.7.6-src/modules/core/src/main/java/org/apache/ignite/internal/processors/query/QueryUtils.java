...
public class QueryUtils {
     ...
     */
    public static String normalizeSchemaName(String cacheName,  String schemaName) {
     ...
     */
    public static  String normalizeObjectName( String str, boolean replace) {
        if (str == null)
            return null;
     ...
     * @throws IgniteCheckedException If failed to build index information.
     */
    public static void processDynamicIndexChange(String idxName,  QueryIndex idx, QueryTypeDescriptorImpl d)
        throws IgniteCheckedException {
        d.dropIndex(idxName);
     ...
     */
     public static SchemaOperationException wrapIfNeeded( Exception e) {
        if (e == null)
            return null;
