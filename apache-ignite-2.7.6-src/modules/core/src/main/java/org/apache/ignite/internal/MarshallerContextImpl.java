...
public class MarshallerContextImpl implements MarshallerContext {
     ...
     */
    public MarshallerContextImpl( Collection<PluginProvider> plugins, IgnitePredicate<String> clsFilter) {
     ...
     */
    public void setMarshallerMappingFileStoreDir( final File marshallerMappingFileStoreDir) {
