...
abstract class GridClientAbstractProjection<T extends GridClientAbstractProjection> {
     ...
     * @throws GridClientException If failed to refresh topology.
     */
    protected Collection<? extends GridClientNode> projectionNodes( GridClientPredicate<GridClientNode> pred)
     ...
     */
    private GridClientNode balancedNode( final GridClientNode exclude) throws GridClientException {
     ...
     */
    protected T createProjection( Collection<GridClientNode> nodes,
         GridClientPredicate<? super GridClientNode> filter,  GridClientLoadBalancer balancer,
     ...
     */
     private Collection<GridClientNode> intersection( Collection<? extends GridClientNode> first,
         Collection<? extends GridClientNode> second) {
    ...
    protected static interface ProjectionFactory<X extends GridClientAbstractProjection> {
         ...
         * @return Created projection.
         */
        public X create( Collection<GridClientNode> nodes,
             GridClientPredicate<? super GridClientNode> filter, GridClientLoadBalancer balancer);
    }
