...
public abstract class GridCacheAdapter<K, V> implements IgniteInternalCache<K, V>, Externalizable {
    ...
    private static final IgniteClosure RET2VAL =
        new CX1<IgniteInternalFuture<GridCacheReturn>, Object>() {
             @Override public Object applyx(IgniteInternalFuture<GridCacheReturn> fut)
    ...
    /** {@inheritDoc} */
     @Override public final ExpiryPolicy expiry() {
        return null;
    }
    ...
    @SuppressWarnings("ConstantConditions")
     private CacheObject localCachePeek0(KeyCacheObject key,
        boolean heap,
        boolean offheap,
        IgniteCacheExpiryPolicy plc)
     ...
     */
    private void clear( Set<? extends K> keys) throws IgniteCheckedException {
        //TODO IGNITE-7952
        MvccUtils.verifyMvccOperationSupport(ctx, "Clear");
     ...
     * @return Future.
     */
    private IgniteInternalFuture<?> clearAsync( final Set<? extends K> keys) {
        //TODO IGNITE-7952
        MvccUtils.verifyMvccOperationSupport(ctx, "Clear");
     ...
     * @return Clear future.
     */
    private IgniteInternalFuture<?> clearLocallyAsync( final Set<? extends K> keys) {
     ...
     * @return Future.
     */
    private IgniteInternalFuture<?> executeClearTask( Set<? extends K> keys, boolean near) {
    ...
    /** {@inheritDoc} */
     @Override public final Map<K, V> getAllOutTx(Set<? extends K> keys) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
     @Override public CacheEntry<K, V> getEntry(K key) throws IgniteCheckedException {
        A.notNull(key, "key");
    ...
    /** {@inheritDoc} */
    @Override public final Map<K, V> getAll( Collection<? extends K> keys) throws IgniteCheckedException {
        A.notNull(keys, "keys");
    ...
    /** {@inheritDoc} */
    @Override public Collection<CacheEntry<K, V>> getEntries( Collection<? extends K> keys)
        throws IgniteCheckedException {
        A.notNull(keys, "keys");
    ...
    /** {@inheritDoc} */
    @Override public IgniteInternalFuture<Map<K, V>> getAllAsync( final Collection<? extends K> keys) {
        A.notNull(keys, "keys");
    ...
    private Map<K, V> interceptGet( Collection<? extends K> keys, Map<K, V> map) {
        if (F.isEmpty(keys))
            return map;
    ...
    private Collection<CacheEntry<K, V>> interceptGetEntries(
         Collection<? extends K> keys, Map<K, EntryGetResult> map) {
        if (F.isEmpty(keys)) {
            assert map.isEmpty();
     ...
     * @see GridCacheAdapter#getAllAsync(Collection)
     */
    public final IgniteInternalFuture<Map<K, V>> getAllAsync( final Collection<? extends K> keys,
         final ReaderArguments readerArgs,
        boolean readThrough,
        boolean checkTx,
         final UUID subjId,
    ...
    protected final <K1, V1> IgniteInternalFuture<Map<K1, V1>> getAllAsync0(
        ...
        final String taskName,
        final boolean deserializeBinary,
         final IgniteCacheExpiryPolicy expiry,
        final boolean skipVals,
     ...
     * @throws IgniteCheckedException If failed.
     */
     public V getAndPut(final K key, final V val,  final CacheEntryPredicate filter)
        throws IgniteCheckedException {
        boolean statsEnabled = ctx.statisticsEnabled();
     ...
     * @throws IgniteCheckedException If failed.
     */
    protected V getAndPut0(final K key, final V val,  final CacheEntryPredicate filter)
        throws IgniteCheckedException {
     ...
     */
    protected final IgniteInternalFuture<V> getAndPutAsync(K key, V val,  CacheEntryPredicate filter) {
        final boolean statsEnabled = ctx.statisticsEnabled();
    ...
    /** {@inheritDoc} */
     @Override public final <T> EntryProcessorResult<T> invoke( AffinityTopologyVersion topVer,
        K key,
     ...
     * @return Put future.
     */
    public final IgniteInternalFuture<Boolean> putAsync(K key, V val,  CacheEntryPredicate filter) {
        A.notNull(key, "key", val, "val");
    ...
    /** {@inheritDoc} */
     @Override public final V getAndPutIfAbsent(final K key, final V val) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
     @Override public final V getAndReplace(final K key, final V val) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
    @Override public void putAll( final Map<? extends K, ? extends V> m) throws IgniteCheckedException {
        A.notNull(m, "map");
    ...
    /** {@inheritDoc} */
     @Override public V getAndRemove(final K key) throws IgniteCheckedException {
        boolean statsEnabled = ctx.statisticsEnabled();
    ...
    /** {@inheritDoc} */
    @Override public IgniteInternalFuture<?> removeAllAsync( final Collection<? extends K> keys) {
        if (F.isEmpty(keys))
            return new GridFinishedFuture<Object>();
     ...
     * @throws IgniteCheckedException If failed.
     */
    public boolean remove(final K key,  CacheEntryPredicate filter) throws IgniteCheckedException {
        boolean statsEnabled = ctx.statisticsEnabled();
     ...
     * @return Putx operation future.
     */
    public IgniteInternalFuture<Boolean> removeAsync(final K key,  final CacheEntryPredicate filter) {
        final boolean statsEnabled = ctx.statisticsEnabled();
     ...
     * @return Future.
     */
    protected IgniteInternalFuture<Boolean> removeAsync0(final K key,  final CacheEntryPredicate filter) {
        return asyncOp(new AsyncOp<Boolean>() {
            @Override public IgniteInternalFuture<Boolean> op(GridNearTxLocal tx, AffinityTopologyVersion readyTopVer) {
                return tx.removeAllAsync(ctx,
                    readyTopVer,
    ...
    /** {@inheritDoc} */
    @Override public boolean lockAll( Collection<? extends K> keys, long timeout)
        throws IgniteCheckedException {
        if (F.isEmpty(keys))
            return true;
     ...
     * @throws IgniteCheckedException If failed.
     */
    public void localLoad(Collection<? extends K> keys,  ExpiryPolicy plc, final boolean keepBinary)
        throws IgniteCheckedException {
        //TODO IGNITE-7954
        MvccUtils.verifyMvccOperationSupport(ctx, "Load");
     ...
     * @throws IgniteCheckedException If failed.
     */
    void globalLoadCache( IgniteBiPredicate<K, V> p,  Object... args) throws IgniteCheckedException {
     ...
     * @throws IgniteCheckedException If failed.
     */
    IgniteInternalFuture<?> globalLoadCacheAsync( IgniteBiPredicate<K, V> p,  Object... args)
        throws IgniteCheckedException {
     ...
     * @throws IgniteCheckedException If failed.
     */
     public final V get(K key, boolean deserializeBinary,
     ...
     * @throws GridCacheEntryRemovedException If entry removed.
     */
     private Cache.Entry<K, V> toCacheEntry(GridCacheEntryEx entry,
        boolean deserializeBinary)
     ...
     */
     public final IgniteCacheExpiryPolicy expiryPolicy( ExpiryPolicy plc) {
        if (plc == null)
            plc = ctx.expiry();
    ...
    private abstract class SyncOp<T> {
         ...
         * @throws IgniteCheckedException If failed.
         */
         public abstract T op(GridNearTxLocal tx) throws IgniteCheckedException;
    }
    ...
    private abstract class SyncInOp extends SyncOp<Object> {
        ...
        /** {@inheritDoc} */
         @Override public final Object op(GridNearTxLocal tx) throws IgniteCheckedException {
            inOp(tx);
    ...
    private static class GlobalClearAllJob extends TopologyVersionAwareJob {
        ...
        /** {@inheritDoc} */
         @Override public Object localExecute( IgniteInternalCache cache) {
            if (cache != null)
    ...
    protected static class FutureHolder {
         ...
         * @param fut Future.
         */
        public void future( IgniteInternalFuture fut) {
            this.fut = fut;
        }
    }
    ...
    protected abstract static class CacheExpiryPolicy implements IgniteCacheExpiryPolicy {
         ...
         */
         private static CacheExpiryPolicy forPolicy( final ExpiryPolicy expiryPlc) {
            if (expiryPlc == null)
                return null;
         ...
         */
         @Override public Map<KeyCacheObject, GridCacheVersion> entries() {
            return entries;
        }

        /** {@inheritDoc} */
         @Override public Map<UUID, Collection<IgniteBiTuple<KeyCacheObject, GridCacheVersion>>> readers() {
            return rdrsMap;
        }
    ...
    private class LocalStoreLoadClosure extends CIX3<KeyCacheObject, Object, GridCacheVersion> {
         ...
         * @param plc Optional expiry policy.
         */
        private LocalStoreLoadClosure( IgniteBiPredicate<K, V> p,
    ...
    public static abstract class TopologyVersionAwareJob extends ComputeJobAdapter {
         ...
         */
         protected abstract Object localExecute( IgniteInternalCache cache);
