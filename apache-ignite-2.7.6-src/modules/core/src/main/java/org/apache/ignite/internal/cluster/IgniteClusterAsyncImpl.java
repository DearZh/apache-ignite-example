...
public class IgniteClusterAsyncImpl extends AsyncSupportAdapter<IgniteCluster>
    ...
    @Override public IgniteFuture<Collection<ClusterStartNodeResult>> startNodesAsync(
        Collection<Map<String, Object>> hosts,  Map<String, Object> dflts,
    ...
    /** {@inheritDoc} */
    @Override public ClusterGroup forAttribute(String name,  Object val) {
    ...
    /** {@inheritDoc} */
     @Override public ClusterNode node(UUID id) {
    ...
    /** {@inheritDoc} */
     @Override public Collection<BaselineNode> currentBaselineTopology() {
        return null;
    }
    ...
    /** {@inheritDoc} */
     @Override public IgniteFuture<?> clientReconnectFuture() {
