...
public abstract class GridCacheQueryManager<K, V> extends GridCacheManagerAdapter<K, V> {
     ...
     */
    public void store(CacheDataRow newRow,  CacheDataRow prevRow,
     ...
     */
    public void remove(KeyCacheObject key,  CacheDataRow prevRow)
        throws IgniteCheckedException {
     ...
     */
    @SuppressWarnings("unchecked")
    private QueryResult<K, V> executeQuery(GridCacheQueryAdapter<?> qry,  Object[] args,
        IgniteClosure transformer, boolean loc,  UUID subjId,  String taskName, Object rcpt)
        throws IgniteCheckedException {
        if (qry.type() == null) {
            assert !loc;
     ...
     * @throws IgniteCheckedException In case of error.
     */
    private FieldsResult executeFieldsQuery(GridCacheQueryAdapter<?> qry,  Object[] args,
        boolean loc,  UUID subjId,  String taskName, Object rcpt) throws IgniteCheckedException {
        assert qry != null;
     ...
     */
    private void injectResources( Object o) throws IgniteCheckedException {
        if (o != null) {
    ...
    protected void removeQueryResult( UUID sndId, long reqId) {
        if (sndId == null)
            return;
     ...
     */
    @SuppressWarnings("SynchronizationOnLocalVariableOrMethodParameter")
    protected void removeFieldsQueryResult( UUID sndId, long reqId) {
        if (sndId == null)
            return;
    ...
    public static class CacheSqlMetadata implements GridCacheSqlMetadata {
         ...
         */
        CacheSqlMetadata( String cacheName, Collection<String> types, Map<String, String> keyClasses,
    ...
    private abstract static class CachedResult<R> extends GridFutureAdapter<IgniteSpiCloseableIterator<R>> {
        ...
        /** {@inheritDoc} */
        @Override public boolean onDone( IgniteSpiCloseableIterator<R> res,  Throwable err) {
            assert !isDone();
     ...
     */
    public <R> CacheQuery<R> createScanQuery( IgniteBiPredicate<K, V> filter,
         Integer part, boolean keepBinary) {
     ...
     * @return Created query.
     */
    public <T, R> CacheQuery<R> createScanQuery( IgniteBiPredicate<K, V> filter,
         IgniteClosure<T, R> trans,
         Integer part, boolean keepBinary, boolean forceLocal) {
