...
public class GridLogThrottle {
     ...
     * @param msg Message.
     */
    public static void error( IgniteLogger log,  Throwable e, String msg) {
     ...
     */
    public static void error( IgniteLogger log,  Throwable e, String msg, boolean byMsg) {
        assert !F.isEmpty(msg);
     ...
     * @param byMsg Errors group by message, not by tuple(error, msg).
     */
    public static void warn( IgniteLogger log,  Throwable e, String msg, boolean quite, boolean byMsg) {
        assert !F.isEmpty(msg);
     ...
     */
    public static void warn( IgniteLogger log, String msg, boolean quiet) {
        assert !F.isEmpty(msg);
     ...
     */
    public static void info( IgniteLogger log, String msg, boolean quiet) {
        assert !F.isEmpty(msg);
    ...
    private static void log( IgniteLogger log,
         Throwable e,
        String longMsg,
        LogLevel level,
        boolean quiet,
     ...
     */
    private static boolean replace(IgniteBiTuple<Class<? extends Throwable>, String> t,  Long oldStamp,
        Long newStamp) {
