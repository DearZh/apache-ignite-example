...
public class CacheAffinitySharedManager<K, V> extends GridCacheSharedManagerAdapter<K, V> {
     ...
     */
     private List<DynamicCacheDescriptor> clientCachesToStart(UUID reqId,
     ...
     */
     private Map<Integer, Boolean> processClientCacheStartRequests(
     ...
     */
     private WaitRebalanceInfo initAffinityOnNodeJoin(final GridDhtPartitionsExchangeFuture fut, boolean crd)
        throws IgniteCheckedException {
        final ExchangeDiscoveryEvents evts = fut.context().events();
    ...
    private class CacheGroupHolder1 extends CacheGroupHolder {
         ...
         */
        CacheGroupHolder1(CacheGroupContext grp,  GridAffinityAssignmentCache initAff) {
    ...
    private static class CacheGroupHolder2 extends CacheGroupHolder {
        ...
        static CacheGroupHolder2 create(
            ...
            AffinityTopologyVersion topVer,
             GridAffinityAssignmentCache initAff) throws IgniteCheckedException {
            assert grpDesc != null;
