...
public class GridPartitionedSingleGetFuture extends GridCacheFutureAdapter<Object> implements GridCacheFuture<Object>,
     ...
     * @return {@code True} if should process received response.
     */
    private boolean checkError( IgniteCheckedException err,
     ...
     */
    private void setResult( GridCacheEntryInfo info) {
     ...
     * @param ver Version.
     */
    private void setSkipValueResult(boolean res,  GridCacheVersion ver) {
        assert skipVals;
     ...
     * @param ver Version.
     */
    private void setResult( CacheObject val,  GridCacheVersion ver) {
