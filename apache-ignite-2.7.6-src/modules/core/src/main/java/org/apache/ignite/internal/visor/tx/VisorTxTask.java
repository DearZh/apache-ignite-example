...
public class VisorTxTask extends VisorMultiNodeTask<VisorTxTaskArg, Map<ClusterNode, VisorTxTaskResult>, VisorTxTaskResult> {
    ...
    /** {@inheritDoc} */
     @Override protected Map<ClusterNode, VisorTxTaskResult> reduce0(List<ComputeJobResult> results) throws IgniteException {
    ...
    private static class VisorTxJob extends VisorJob<VisorTxTaskArg, VisorTxTaskResult> {
        ...
        /** {@inheritDoc} */
        @Override protected VisorTxTaskResult run( VisorTxTaskArg arg) throws IgniteException {
            if (arg == null)
