...
public class CacheInterceptorAdapter<K, V> implements CacheInterceptor<K, V> {
    ...
    /** {@inheritDoc} */
     @Override public V onGet(K key, V val) {
        return val;
    }

    /** {@inheritDoc} */
     @Override public V onBeforePut(Cache.Entry<K, V> entry, V newVal) {
        return newVal;
    }
    ...
    /** {@inheritDoc} */
     @Override public IgniteBiTuple<Boolean, V> onBeforeRemove(Cache.Entry<K, V> entry) {
