...
public interface IgniteCacheObjectProcessor extends GridProcessor {
     ...
     */
     public CacheObject prepareForCache( CacheObject obj, GridCacheContext cctx);
     ...
     * @return Cache object.
     */
     public CacheObject toCacheObject(CacheObjectContext ctx,  Object obj, boolean userObj);
