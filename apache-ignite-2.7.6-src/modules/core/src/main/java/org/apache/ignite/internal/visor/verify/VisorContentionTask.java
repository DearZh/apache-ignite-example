...
public class VisorContentionTask extends VisorMultiNodeTask<VisorContentionTaskArg,
    ...
    /** {@inheritDoc} */
     @Override protected VisorContentionTaskResult reduce0(List<ComputeJobResult> list) throws IgniteException {
    ...
    private static class VisorContentionJob extends VisorJob<VisorContentionTaskArg, VisorContentionJobResult> {
         ...
         * @param debug Debug.
         */
        protected VisorContentionJob( VisorContentionTaskArg arg, boolean debug) {
            super(arg, debug);
        }

        /** {@inheritDoc} */
        @Override protected VisorContentionJobResult run( VisorContentionTaskArg arg) throws IgniteException {
            try {
