...
public class IgfsUtils {
     ...
     */
    public static boolean isRootId( IgniteUuid id) {
     ...
     */
    public static String fixUserName( String user) {
        if (F.isEmpty(user))
     ...
     */
    public static boolean matchIgfsCacheName( String cacheName) {
     ...
     * @return {@code True} in this is IGFS data or meta cache.
     */
    public static boolean isIgfsCache(IgniteConfiguration cfg,  String cacheName) {
     ...
     * @return File info.
     */
    public static IgfsFileInfo createFile(IgniteUuid id, int blockSize, long len,  IgniteUuid affKey,
         IgniteUuid lockId, boolean evictExclude,  Map<String, String> props, long accessTime,
        long modificationTime) {
     ...
     * @param entry Entry.
     */
    public static void writeListingEntry(BinaryRawWriter out,  IgfsListingEntry entry) {
        if (entry != null) {
     ...
     */
    public static void writeListingEntry(DataOutput out,  IgfsListingEntry entry) throws IOException {
        if (entry != null) {
            out.writeBoolean(true);
    ...
    public static void writeProperties(BinaryRawWriter out,  Map<String, String> props) {
        if (props != null) {
     ...
     */
    @SuppressWarnings("StringEquality")
    public static void writeProperties(DataOutput out,  Map<String, String> props) throws IOException {
        if (props != null) {
            out.writeInt(props.size());
     ...
     * @param path Path.
     */
    public static void writePath(BinaryRawWriter writer,  IgfsPath path) {
        if (path != null) {
     ...
     */
    public static void writeFileAffinityRange(BinaryRawWriter writer,  IgfsFileAffinityRange affRange) {
        if (affRange != null) {
            writer.writeBoolean(true);
    ...
    public static ArrayList<T2<IgfsPath, IgfsMode>> preparePathModes(final IgfsMode dfltMode,
         List<T2<IgfsPath, IgfsMode>> modes, Set<IgfsPath> dualParentsContainingPrimaryChildren)
        throws IgniteCheckedException {
        if (modes == null)
            return null;
     ...
     * @throws IOException If failed.
     */
    public static void writeUTF(DataOutput out,  String val) throws IOException {
        if (val == null)
            out.writeInt(-1);
        else {
