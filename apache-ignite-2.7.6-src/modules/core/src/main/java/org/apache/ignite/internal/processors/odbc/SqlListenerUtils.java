...
public abstract class SqlListenerUtils {
     ...
     */
     public static Object readObject(BinaryReaderExImpl reader, boolean binObjAllow)
     ...
     * @throws BinaryObjectException On error.
     */
    public static void writeObject(BinaryWriterExImpl writer,  Object obj, boolean binObjAllow)
        throws BinaryObjectException {
        if (obj == null) {
