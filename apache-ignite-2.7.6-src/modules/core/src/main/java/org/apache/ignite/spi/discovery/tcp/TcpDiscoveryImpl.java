...
abstract class TcpDiscoveryImpl {
     ...
     */
     public abstract ClusterNode getNode(UUID nodeId);
     ...
     */
    public abstract void failNode(UUID nodeId,  String warning);
     ...
     * @throws IgniteSpiException If failed.
     */
    public abstract void spiStart( String igniteInstanceName) throws IgniteSpiException;
