...
public class GridCacheOffheapManager extends IgniteCacheOffheapManagerImpl implements DbCheckpointListener {
     ...
     */
     private static Map<Integer, Long> readSharedGroupCacheSizes(PageSupport pageMem, int grpId,
    ...
    /** {@inheritDoc} */
    @Override  protected IgniteHistoricalIterator historicalIterator(
    ...
    public class GridCacheDataStore implements CacheDataStore {
        ...
        @Override public int cleanup(GridCacheContext cctx,
             List<MvccLinkAwareSearchRow> cleanupRows) throws IgniteCheckedException {
            CacheDataStore delegate = init0(false);
