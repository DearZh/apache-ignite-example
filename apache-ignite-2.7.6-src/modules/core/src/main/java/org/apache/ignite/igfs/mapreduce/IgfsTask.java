...
public abstract class IgfsTask<T, R> extends ComputeTaskAdapter<IgfsTaskArgs<T>, R> {
    ...
    /** {@inheritDoc} */
     @Override public final Map<? extends ComputeJob, ClusterNode> map(List<ClusterNode> subgrid,
         IgfsTaskArgs<T> args) {
        assert ignite != null;
        assert args != null;
     ...
     */
     public abstract IgfsJob createJob(IgfsPath path, IgfsFileRange range,
