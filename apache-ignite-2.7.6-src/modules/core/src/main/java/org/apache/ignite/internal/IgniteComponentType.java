...
public enum IgniteComponentType {
    ...
    private <T> T createOptional0( GridKernalContext ctx) throws IgniteCheckedException {
        Class<?> cls;
     ...
     */
    @SuppressWarnings("unchecked")
    private <T> T create0( GridKernalContext ctx, String clsName) throws IgniteCheckedException {
        try {
