...
public interface IgniteFileSystem extends IgniteAsyncSupport {
     ...
     * @throws IgfsPathNotFoundException If path doesn't exist and create flag is {@code false}.
     */
    public IgfsOutputStream append(IgfsPath path, int bufSize, boolean create,  Map<String, String> props)
        throws IgniteException;
     ...
     */
    public <T, R> R execute(IgfsTask<T, R> task,  IgfsRecordResolver rslvr,
     ...
     * @throws IgniteException If execution failed.
     */
    public <T, R> IgniteFuture<R> executeAsync(IgfsTask<T, R> task,  IgfsRecordResolver rslvr,
        Collection<IgfsPath> paths,  T arg) throws IgniteException;
    ...
    public <T, R> R execute(Class<? extends IgfsTask<T, R>> taskCls,
        ...
        long maxRangeLen,  T arg) throws IgniteException;
     ...
     * @throws IgniteException In case of error.
     */
    public void mkdirs(IgfsPath path,  Map<String, String> props) throws IgniteException;
