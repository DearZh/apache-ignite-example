...
public class VisorNodeEventsCollectorTaskArg extends VisorDataTransferObject {
     ...
     */
    public VisorNodeEventsCollectorTaskArg( String keyOrder,  int[] typeArg,
         Long timeArg,
         String taskName,  IgniteUuid taskSesId) {
     ...
     * @param timeArg Arguments for time filter.
     */
    public static VisorNodeEventsCollectorTaskArg createEventsArg( int[] typeArg,  Long timeArg) {
     ...
     * @param taskSesId Arguments for task session filter.
     */
    public static VisorNodeEventsCollectorTaskArg createTasksArg( Long timeArg,  String taskName,
     ...
     * @param typeArg Arguments for type filter.
     */
    public static VisorNodeEventsCollectorTaskArg createLogArg( String keyOrder,  int[] typeArg) {
