...
public final class IgfsFileInfo extends IgfsEntryInfo implements Binarylizable {
    ...
    /** {@inheritDoc} */
    @Override public IgfsEntryInfo listing( Map<String, IgfsListingEntry> listing) {
     ...
     */
    IgfsFileInfo(IgniteUuid id, int blockSize, long len,  IgniteUuid affKey,
         Map<String, String> props,  IgfsFileMap fileMap,  IgniteUuid lockId,
