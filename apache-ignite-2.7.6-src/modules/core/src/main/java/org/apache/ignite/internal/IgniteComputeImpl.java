...
public class IgniteComputeImpl extends AsyncSupportAdapter<IgniteCompute>
    ...
    /** {@inheritDoc} */
    @Override public void affinityRun(Collection<String> cacheNames, Object affKey, IgniteRunnable job) {
    ...
    /** {@inheritDoc} */
    @Override public IgniteFuture<Void> affinityRunAsync(Collection<String> cacheNames, Object affKey,
        IgniteRunnable job) throws IgniteException {
        CU.validateCacheNames(cacheNames);
     ...
     * @return Internal future.
     */
    private IgniteInternalFuture<?> affinityRunAsync0(Collection<String> cacheNames, Object affKey,
        IgniteRunnable job) {
        A.notNull(affKey, "affKey");
        A.notNull(job, "job");
    ...
    /** {@inheritDoc} */
    @Override public void affinityRun(Collection<String> cacheNames, int partId, IgniteRunnable job) {
        CU.validateCacheNames(cacheNames);
    ...
    /** {@inheritDoc} */
    @Override public IgniteFuture<Void> affinityRunAsync(Collection<String> cacheNames, int partId,
        IgniteRunnable job) throws IgniteException {
        CU.validateCacheNames(cacheNames);
     ...
     * @return Internal future.
     */
    private IgniteInternalFuture<?> affinityRunAsync0(Collection<String> cacheNames, int partId,
        IgniteRunnable job) {
    ...
    /** {@inheritDoc} */
    @Override public <R> R affinityCall(Collection<String> cacheNames, Object affKey, IgniteCallable<R> job) {
        CU.validateCacheNames(cacheNames);
    ...
    /** {@inheritDoc} */
    @Override public <R> IgniteFuture<R> affinityCallAsync(Collection<String> cacheNames, Object affKey,
        IgniteCallable<R> job) throws IgniteException {
        CU.validateCacheNames(cacheNames);
     ...
     * @return Internal future.
     */
    private <R> IgniteInternalFuture<R> affinityCallAsync0(Collection<String> cacheNames, Object affKey,
        IgniteCallable<R> job) {
        A.notNull(affKey, "affKey");
        A.notNull(job, "job");
        A.ensure(!cacheNames.isEmpty(), "cachesNames mustn't be empty");
    ...
    /** {@inheritDoc} */
    @Override public <R> R affinityCall(Collection<String> cacheNames, int partId, IgniteCallable<R> job) {
        CU.validateCacheNames(cacheNames);
    ...
    /** {@inheritDoc} */
    @Override public <R> IgniteFuture<R> affinityCallAsync(Collection<String> cacheNames, int partId,
        IgniteCallable<R> job) throws IgniteException {
        CU.validateCacheNames(cacheNames);
     ...
     * @return Internal future.
     */
    private <R> IgniteInternalFuture<R> affinityCallAsync0(Collection<String> cacheNames, int partId,
        IgniteCallable<R> job) {
        A.ensure(partId >= 0, "partId = " + partId);
        A.notNull(job, "job");
        A.ensure(!cacheNames.isEmpty(), "cachesNames mustn't be empty");
    ...
    @Override public <T, R> R execute(String taskName,  T arg) {
        try {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> ComputeTaskFuture<R> executeAsync(String taskName,  T arg) throws IgniteException {
     ...
     */
    @SuppressWarnings("unchecked")
    private <T, R> IgniteInternalFuture<R> executeAsync0(String taskName,  T arg) {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> R execute(Class<? extends ComputeTask<T, R>> taskCls,  T arg) {
        try {
     ...
     */
    @SuppressWarnings("unchecked")
    private <T, R> IgniteInternalFuture<R> executeAsync0(Class<? extends ComputeTask<T, R>> taskCls,  T arg) {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> R execute(ComputeTask<T, R> task,  T arg) {
        try {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> ComputeTaskFuture<R> executeAsync(ComputeTask<T, R> task,  T arg)
     ...
     * @return Task future.
     */
    public <T, R> ComputeTaskInternalFuture<R> executeAsync0(ComputeTask<T, R> task,  T arg) {
        A.notNull(task, "task");
    ...
    /** {@inheritDoc} */
    @Override public <R, T> Collection<R> broadcast(IgniteClosure<T, R> job,  T arg) {
        try {
     ...
     * @return Internal future.
     */
    private <R, T> IgniteInternalFuture<Collection<R>> broadcastAsync0(IgniteClosure<T, R> job,  T arg) {
        A.notNull(job, "job");
    ...
    /** {@inheritDoc} */
    @Override public <R, T> R apply(IgniteClosure<T, R> job,  T arg) {
        try {
    ...
    /** {@inheritDoc} */
    @Override public <R, T> IgniteFuture<R> applyAsync(IgniteClosure<T, R> job,  T arg)
        throws IgniteException {
     ...
     * @return Internal future.
     */
    private <R, T> IgniteInternalFuture<R> applyAsync0(IgniteClosure<T, R> job,  T arg) {
        A.notNull(job, "job");
    ...
    /** {@inheritDoc} */
    @Override public <T, R> Collection<R> apply(final IgniteClosure<T, R> job,  Collection<? extends T> args) {
        try {
