...
public class IgniteCacheProxyImpl<K, V> extends AsyncSupportAdapter<IgniteCache<K, V>>
    ...
    private IgniteCacheProxyImpl(
        GridCacheContext<K, V> ctx,
        IgniteInternalCache<K, V> delegate,
        AtomicReference<RestartFuture> restartFut,
        boolean async
    ) {
        super(async);
    ...
    /** {@inheritDoc} */
    @Override public void loadCache( IgniteBiPredicate<K, V> p,  Object... args) {
        try {
            if (isAsync()) {
    ...
    /** {@inheritDoc} */
    @Override public IgniteFuture<Void> loadCacheAsync( IgniteBiPredicate<K, V> p,
    ...
    /** {@inheritDoc} */
    @Override public void localLoadCache( IgniteBiPredicate<K, V> p,  Object... args) {
        try {
            if (isAsync())
    ...
    /** {@inheritDoc} */
    @Override public IgniteFuture<Void> localLoadCacheAsync( IgniteBiPredicate<K, V> p,
         Object... args) throws CacheException {
    ...
    private <T, R> QueryCursor<R> query(
        final ScanQuery scanQry,
         final IgniteClosure<T, R> transformer,
         ClusterGroup grp)
     ...
     */
    @SuppressWarnings("unchecked")
    private QueryCursor<Cache.Entry<K, V>> query(final Query filter,  ClusterGroup grp)
        throws IgniteCheckedException {
    ...
    @Override public void loadAll(
        ...
        boolean replaceExisting,
         final CompletionListener completionLsnr
    ) {
     ...
     */
    public <T> T invoke( AffinityTopologyVersion topVer,
        K key,
