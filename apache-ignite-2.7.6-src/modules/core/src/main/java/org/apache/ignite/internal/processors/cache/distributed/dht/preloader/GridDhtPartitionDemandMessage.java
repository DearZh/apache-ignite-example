...
public class GridDhtPartitionDemandMessage extends GridCacheGroupIdMessage {
     ...
     */
    GridDhtPartitionDemandMessage(long rebalanceId, AffinityTopologyVersion topVer, int grpId) {
        this.grpId = grpId;
     ...
     */
    public GridDhtPartitionDemandMessage withNewPartitionsMap(IgniteDhtDemandedPartitionsMap parts) {
