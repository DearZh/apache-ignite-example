...
public class F0 {
    ...
    public static <T> IgnitePredicate<T> and( final IgnitePredicate<? super T>[] p1,
         final IgnitePredicate<? super T>... p2) {
    ...
    public static <T> IgnitePredicate<T> and(
         ...
         final IgnitePredicate<? super T>... ps
    ) {
     ...
     *      contained in given collection.
     */
    public static <T> IgnitePredicate<T> in( final Collection<? extends T> c) {
