...
public class TcpDiscoveryCustomEventMessage extends TcpDiscoveryAbstractMessage {
     ...
     * @param msgBytes Serialized message.
     */
    public void message( DiscoverySpiCustomMessage msg, byte[] msgBytes) {
        this.msg = msg;
        this.msgBytes = msgBytes;
    }
     ...
     */
     public DiscoverySpiCustomMessage message(Marshaller marsh, ClassLoader ldr) throws Throwable {
        if (msg == null) {
