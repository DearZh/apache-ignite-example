...
public class CacheObjectBinaryProcessorImpl extends IgniteCacheObjectProcessorImpl implements
     ...
     */
    public byte[] marshal( Object obj) throws BinaryObjectException {
    ...
    @Override public void updateMetadata(int typeId, String typeName,  String affKeyFieldName,
        Map<String, BinaryFieldMetadata> fieldTypeIds, boolean isEnum,  Map<String, Integer> enumMap)
        throws BinaryObjectException {
    ...
    /** {@inheritDoc} */
     @Override public BinaryType metadata(final int typeId) {
    ...
    /** {@inheritDoc} */
     @Override public BinaryType metadata(final int typeId, final int schemaId) {
        BinaryMetadataHolder holder = metadataLocCache.get(typeId);
    ...
    /** {@inheritDoc} */
    @Override public KeyCacheObject toCacheKeyObject(CacheObjectContext ctx,  GridCacheContext cctx,
    ...
    /** {@inheritDoc} */
     @Override public CacheObject toCacheObject(CacheObjectContext ctx,  Object obj,
     ...
     * @throws IgniteException In case of error.
     */
     public Object toBinary( Object obj, boolean failIfUnregistered) throws IgniteException {
        if (obj == null)
            return null;
    ...
    /** {@inheritDoc} */
     @Override public IgniteNodeValidationResult validateNode(ClusterNode rmtNode,
     ...
     */
    public void setBinaryMetadataFileStoreDir( File binaryMetadataFileStoreDir) {
