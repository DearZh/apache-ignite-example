...
public class GridCacheUtils {
     ...
     * @return Filter array.
     */
    public static CacheEntryPredicate[] filterArray( CacheEntryPredicate filter) {
     ...
     */
    public static String txString( IgniteInternalTx tx) {
        if (tx == null)
            return "null";
    ...
    public static void checkAttributeMismatch(IgniteLogger log, String cfgName, UUID rmtNodeId, String attrName,
        String attrMsg,  Object locVal,  Object rmtVal, boolean fail) throws IgniteCheckedException {
        assert rmtNodeId != null;
     ...
     */
    public static void validateCacheKey( Object key) {
        if (key == null)
            return;
     ...
     * @return Group ID.
     */
    public static int cacheGroupId(String cacheName,  String grpName) {
     ...
     */
     public static <T> T value( CacheObject cacheObj, GridCacheContext ctx, boolean cpy) {
     ...
     */
    public static TransactionConfiguration transactionConfiguration(final  GridCacheContext sysCacheCtx,
     ...
     */
     public static BackupPostProcessingClosure createBackupPostProcessingClosure(
