...
public class IgfsDataManager extends IgfsManager {
    ...
    public IgniteUuid nextAffinityKey( IgniteUuid prevAffKey) {
     ...
     */
     public IgniteInternalFuture<byte[]> dataBlock(final IgfsEntryInfo fileInfo, final IgfsPath path,
        final long blockIdx,  final IgfsSecondaryFileSystemPositionedReadable secReader)
     ...
     * @throws IgniteCheckedException If failed.
     */
     public byte[] secondaryDataBlock(IgfsPath path, long blockIdx,
