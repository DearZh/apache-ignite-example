...
public interface GridDhtPartitionTopology {
     ...
     */
     public GridDhtLocalPartition localPartition(int p, AffinityTopologyVersion topVer, boolean create)
     ...
     * @return {@code True} if local state was changed.
     */
    public boolean update( GridDhtPartitionExchangeId exchId,
     ...
     */
    void globalPartSizes( Map<Integer, Long> partSizes);
