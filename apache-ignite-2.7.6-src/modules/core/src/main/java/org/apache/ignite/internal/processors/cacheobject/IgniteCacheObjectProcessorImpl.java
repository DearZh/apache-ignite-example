...
public class IgniteCacheObjectProcessorImpl extends GridProcessorAdapter implements IgniteCacheObjectProcessor {
    ...
    /** {@inheritDoc} */
     @Override public CacheObject prepareForCache( CacheObject obj, GridCacheContext cctx) {
        if (obj == null)
            return null;
    ...
    @Override public IncompleteCacheObject toCacheObject(
        ...
        final ByteBuffer buf,
         IncompleteCacheObject incompleteObj
    ) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
     @Override public CacheObject toCacheObject(CacheObjectContext ctx,
         Object obj,
        boolean userObj) {
    ...
    /** {@inheritDoc} */
     @Override public CacheObject toCacheObject(CacheObjectContext ctx,  Object obj, boolean userObj,
     ...
     */
    @SuppressWarnings("ExternalizableWithoutPublicNoArgConstructor")
    protected CacheObject toCacheObject0( Object obj, boolean userObj) {
        assert obj != null;
     ...
     */
    protected final int partition(CacheObjectContext ctx,  GridCacheContext cctx, Object obj) {
        try {
            return cctx != null ?
