...
class GridEventConsumeHandler implements GridContinuousHandler {
     ...
     * @param types Types.
     */
    GridEventConsumeHandler( IgniteBiPredicate<UUID, Event> cb,  IgnitePredicate<Event> filter,
         int[] types) {
    ...
    private static class EventWrapper implements GridCacheDeployable, Externalizable {
         ...
         * @throws IgniteCheckedException In case of error.
         */
        void p2pUnmarshal(Marshaller marsh,  ClassLoader ldr) throws IgniteCheckedException {
            assert marsh != null;
