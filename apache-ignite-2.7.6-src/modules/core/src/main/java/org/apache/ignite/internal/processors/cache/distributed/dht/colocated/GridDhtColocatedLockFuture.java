...
public final class GridDhtColocatedLockFuture extends GridCacheCompoundIdentityFuture<Boolean>
     ...
     */
    private void mapOnTopology(final boolean remap,  final Runnable c) {
     ...
     */
    private ClusterTopologyCheckedException newTopologyException( Throwable nested, UUID nodeId) {
