...
public class GridCircularBuffer<T> {
     ...
     */
     public T add(T t,  IgniteInClosureX<T> c) throws InterruptedException, IgniteCheckedException {
        long idx = idxGen.getAndIncrement();
    ...
    private static class Item<V> {
         ...
         * @throws IgniteCheckedException If closure throws exception.
         */
         synchronized V update(long newIdx, V newItem, long maxIdxDiff,  IgniteInClosureX<V> c)
