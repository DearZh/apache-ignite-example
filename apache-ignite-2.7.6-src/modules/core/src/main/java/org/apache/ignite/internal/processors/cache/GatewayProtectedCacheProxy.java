...
public class GatewayProtectedCacheProxy<K, V> extends AsyncSupportAdapter<IgniteCache<K, V>>
    ...
    /** {@inheritDoc} */
    @Override public void loadCache( IgniteBiPredicate<K, V> p,  Object... args) throws CacheException {
        CacheOperationGate opGate = onEnter();
    ...
    /** {@inheritDoc} */
    @Override public IgniteFuture<Void> loadCacheAsync( IgniteBiPredicate<K, V> p,  Object... args) throws CacheException {
        CacheOperationGate opGate = onEnter();
    ...
    /** {@inheritDoc} */
    @Override public void localLoadCache( IgniteBiPredicate<K, V> p,  Object... args) throws CacheException {
        CacheOperationGate opGate = onEnter();
    ...
    /** {@inheritDoc} */
    @Override public IgniteFuture<Void> localLoadCacheAsync( IgniteBiPredicate<K, V> p,  Object... args) throws CacheException {
        CacheOperationGate opGate = onEnter();
     ...
     */
    private GridCacheGateway<K, V> checkProxyIsValid( GridCacheGateway<K, V> gate, boolean tryRestart) {
        if (isProxyClosed())
