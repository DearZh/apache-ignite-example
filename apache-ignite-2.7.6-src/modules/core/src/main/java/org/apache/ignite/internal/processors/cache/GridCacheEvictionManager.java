...
public class GridCacheEvictionManager extends GridCacheManagerAdapter implements CacheEvictionManager {
    ...
    /** {@inheritDoc} */
    @Override public boolean evict( GridCacheEntryEx entry,  GridCacheVersion obsoleteVer,
        boolean explicit,  CacheEntryPredicate[] filter) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
    @Override public void batchEvict(Collection<?> keys,  GridCacheVersion obsoleteVer)
        throws IgniteCheckedException {
        boolean recordable = cctx.events().isRecordable(EVT_CACHE_ENTRY_EVICTED);
     ...
     * @param near Near flag.
     */
    void cleanup(CacheConfiguration cfg,  Object rsrc, boolean near) {
        if (rsrc != null) {
