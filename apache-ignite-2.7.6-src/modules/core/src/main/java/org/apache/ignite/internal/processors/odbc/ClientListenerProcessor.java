...
public class ClientListenerProcessor extends GridProcessorAdapter {
     ...
     */
    private GridNioFilter[] makeFilters(ClientConnectorConfiguration cliConnCfg)
    ...
    @SuppressWarnings("deprecation")
     private ClientConnectorConfiguration prepareConfiguration(IgniteConfiguration cfg)
        throws IgniteCheckedException {
