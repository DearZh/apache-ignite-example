...
public class GridDhtPartitionsFullMessage extends GridDhtPartitionsAbstractMessage {
     ...
     * @param partsToReload
     */
    public GridDhtPartitionsFullMessage( GridDhtPartitionExchangeId id,
     ...
     */
    public void addFullPartitionsMap(int grpId, GridDhtPartitionFullMap fullMap,  Integer dupDataCache) {
        assert fullMap != null;
