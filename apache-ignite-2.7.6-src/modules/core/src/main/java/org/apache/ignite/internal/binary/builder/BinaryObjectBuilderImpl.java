...
public class BinaryObjectBuilderImpl implements BinaryObjectBuilder {
    ...
    /** {@inheritDoc} */
    @Override public <T> BinaryObjectBuilder setField(String name,  T val, Class<? super T> type) {
        byte typeId;
    ...
    /** {@inheritDoc} */
    @Override public BinaryObjectBuilder setField(String name,  BinaryObjectBuilder builder) {
