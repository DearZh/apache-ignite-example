...
public class GridCacheDistributedFieldsQueryFuture
     ...
     */
    public void onPage( UUID nodeId,  List<GridQueryFieldMetadata> metaData,
         Collection<Map<String, Object>> data,  Throwable err, boolean finished) {
    ...
    /** {@inheritDoc} */
    @Override public boolean onDone( Collection<List<Object>> res,  Throwable err) {
        if (!metaFut.isDone())
            metaFut.onDone();
