...
public class VisorQueryDetailMetricsCollectorTask extends VisorMultiNodeTask<VisorQueryDetailMetricsCollectorTaskArg,
    ...
    /** {@inheritDoc} */
     @Override protected Collection<VisorQueryDetailMetrics> reduce0(List<ComputeJobResult> results)
    ...
    private static class VisorCacheQueryDetailMetricsCollectorJob
         ...
         */
        protected VisorCacheQueryDetailMetricsCollectorJob( VisorQueryDetailMetricsCollectorTaskArg arg, boolean debug) {
            super(arg, debug);
        }
        ...
        @Override protected Collection<? extends QueryDetailMetrics> run(
             VisorQueryDetailMetricsCollectorTaskArg arg
        ) throws IgniteException {
            assert arg != null;
