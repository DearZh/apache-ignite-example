...
class ServerImpl extends TcpDiscoveryImpl {
     ...
     */
    private  IgniteBiTuple<UUID, Boolean> pingNode(InetSocketAddress addr,  UUID nodeId,
         UUID clientNodeId) throws IgniteCheckedException {
        assert addr != null;
    ...
    /** {@inheritDoc} */
    @Override public void failNode(UUID nodeId,  String warning) {
        TcpDiscoveryNode node = ring.node(nodeId);
     ...
     */
     private Integer sendMessageDirectly(TcpDiscoveryAbstractMessage msg, InetSocketAddress addr,
     ...
     */
     private TcpDiscoveryNode resolveCoordinator(
         Collection<TcpDiscoveryNode> filter) {
        synchronized (mux) {
    ...
    private void prepareNodeAddedMessage(
        TcpDiscoveryAbstractMessage msg,
        UUID destNodeId,
         Collection<PendingMessage> msgs,
    ...
    private class EnsuredMessageHistory {
         ...
         */
         Collection<TcpDiscoveryAbstractMessage> messages( IgniteUuid lastMsgId,
    ...
    private class SocketReader extends IgniteSpiThread {
        ...
        private boolean processJoinRequestMessage(TcpDiscoveryJoinRequestMessage msg,
             ClientMessageWorker clientMsgWrk) throws IOException {
            assert msg != null;
    ...
    private class ClientMessageWorker extends MessageWorker<T2<TcpDiscoveryAbstractMessage, byte[]>> {
         ...
         */
        void addMessage(TcpDiscoveryAbstractMessage msg,  byte[] msgBytes) {
