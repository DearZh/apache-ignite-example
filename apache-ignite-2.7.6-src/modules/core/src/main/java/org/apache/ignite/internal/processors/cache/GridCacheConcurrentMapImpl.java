...
public abstract class GridCacheConcurrentMapImpl implements GridCacheConcurrentMap {
    ...
    /** {@inheritDoc} */
     @Override public GridCacheMapEntry getEntry(GridCacheContext ctx, KeyCacheObject key) {
     ...
     */
     protected abstract CacheMapHolder entriesMap(GridCacheContext cctx);

    /**
     * @param cacheId Cache ID.
     * @return Map for given cache ID.
     */
     protected abstract CacheMapHolder entriesMapIfExists(Integer cacheId);
