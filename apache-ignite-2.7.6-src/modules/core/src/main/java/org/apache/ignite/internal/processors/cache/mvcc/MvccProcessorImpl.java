...
public class MvccProcessorImpl extends GridProcessorAdapter implements MvccProcessor, DatabaseLifecycleListener {
    ...
    /** {@inheritDoc} */
    @Override public void processClientActiveQueries(UUID nodeId,  GridLongList activeQueries) {
        prevCrdQueries.addNodeActiveQueries(nodeId, activeQueries);
    }

    /** {@inheritDoc} */
    @Override  public MvccCoordinator currentCoordinator() {
        return currentCoordinator(AffinityTopologyVersion.NONE);
    }

    /** {@inheritDoc} */
    @Override  public MvccCoordinator currentCoordinator(AffinityTopologyVersion topVer) {
    ...
    /** {@inheritDoc} */
    @Override  public MvccCoordinator assignedCoordinator() {
        return assignedCrd;
    }
    ...
    /** {@inheritDoc} */
    @Override public MvccSnapshot tryRequestSnapshotLocal( IgniteInternalTx tx) throws ClusterTopologyCheckedException {
    ...
    @Override public void dumpDebugInfo(IgniteLogger log,  IgniteDiagnosticPrepareContext diagCtx) {
        boolean first = true;
    ...
    /** */
    private void checkMvccCacheStarted( DiscoveryCustomMessage customMsg) {
    ...
    private static class VacuumWorker extends GridWorker {
        ...
        /** */
        @SuppressWarnings("unchecked")
        private Object addRest( Object rest, MvccDataRow row) {
            if (rest == null)
                rest = row;
         ...
         */
        private List<MvccLinkAwareSearchRow> addRow( List<MvccLinkAwareSearchRow> rows, MvccDataRow row) {
            if (rows == null)
                rows = new ArrayList<>();
