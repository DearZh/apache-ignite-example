...
class BinaryMetadataCollector implements BinaryWriter {
    ...
    /** {@inheritDoc} */
    @Override public void writeDoubleArray(String fieldName,  double[] val) throws BinaryObjectException {
    ...
    /** {@inheritDoc} */
    @Override public void writeBooleanArray(String fieldName,  boolean[] val) throws BinaryObjectException {
        add(fieldName, BinaryWriteMode.BOOLEAN_ARR);
    }

    /** {@inheritDoc} */
    @Override public void writeDecimalArray(String fieldName,  BigDecimal[] val) throws BinaryObjectException {
        add(fieldName, BinaryWriteMode.DECIMAL_ARR);
    }

    /** {@inheritDoc} */
    @Override public void writeStringArray(String fieldName,  String[] val) throws BinaryObjectException {
    ...
    /** {@inheritDoc} */
    @Override public <K, V> void writeMap(String fieldName,  Map<K, V> map) throws BinaryObjectException {
