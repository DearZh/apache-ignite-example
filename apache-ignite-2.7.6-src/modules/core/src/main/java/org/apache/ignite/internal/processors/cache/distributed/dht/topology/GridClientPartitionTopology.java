...
public class GridClientPartitionTopology implements GridDhtPartitionTopology {
    ...
    /** {@inheritDoc} */
     @Override public GridDhtLocalPartition localPartition(int p, AffinityTopologyVersion topVer,
    ...
    /** {@inheritDoc} */
     @Override public List<ClusterNode> nodes(int p,
    ...
    /** {@inheritDoc} */
     @Override public GridDhtPartitionMap partitions(UUID nodeId) {
        lock.readLock().lock();
    ...
    /** {@inheritDoc} */
    @Override public void globalPartSizes( Map<Integer, Long> partSizes) {
        lock.writeLock().lock();
     ...
     */
    private boolean hasState(final int p,  UUID nodeId, final GridDhtPartitionState match,
