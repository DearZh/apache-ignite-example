...
public class CacheJdbcPojoStore<K, V> extends CacheAbstractJdbcStore<K, V> {
     ...
     */
    @Override  protected Object extractParameter( String cacheName, String typeName, TypeKind typeKind,
     ...
     * @throws CacheException in case of error.
     */
     private Object extractPojoParameter( String cacheName, String typeName, String fldName,
    ...
    /** {@inheritDoc} */
    @Override protected <R> R buildObject( String cacheName, String typeName, TypeKind typeKind,
     ...
     * @throws CacheLoaderException If failed to construct POJO.
     */
    private Object buildPojoObject( String cacheName, String typeName,
        JdbcTypeField[] flds, Map<String, Integer> loadColIdxs, ResultSet rs)
        throws CacheLoaderException {
     ...
     */
    @Override protected void prepareBuilders( String cacheName, Collection<JdbcType> types)
