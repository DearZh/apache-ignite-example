...
public class GridQueryProcessor extends GridProcessorAdapter {
     ...
     */
    public void onCoordinatorFinished(SchemaAbstractOperation op,  SchemaOperationException err) {
        synchronized (stateMux) {
     ...
     */
    public void onLocalOperationFinished(SchemaAbstractOperation op,  QueryTypeDescriptorImpl type) {
        synchronized (stateMux) {
            if (disconnected)
                return;
    ...
    public void dynamicTableCreate(String schemaName, QueryEntity entity, String templateName, String cacheName,
        String cacheGroup,  String dataRegion, String affinityKey,  CacheAtomicityMode atomicityMode,
         CacheWriteSynchronizationMode writeSyncMode,  Integer backups, boolean ifNotExists,
     ...
     */
    private IgniteInternalFuture<Object> rebuildIndexesFromHash( final String cacheName,
         final QueryTypeDescriptorImpl desc) {
        if (idx == null)
    ...
    public void store(GridCacheContext cctx, CacheDataRow newRow,  CacheDataRow prevRow,
     ...
     */
    @SuppressWarnings("ConstantConditions")
     private QueryTypeDescriptorImpl typeByValue(String cacheName,
     ...
     */
    @SuppressWarnings("unchecked")
    public List<FieldsQueryCursor<List<?>>> querySqlFields( final GridCacheContext<?, ?> cctx,
     ...
     */
    public long streamUpdateQuery( final String cacheName, final String schemaName,
     ...
     * @return Descriptors.
     */
    public Collection<GridQueryTypeDescriptor> types( String cacheName) {
     ...
     * @return Type (if any).
     */
     private QueryTypeDescriptorImpl type( String cacheName, String tblName) {
     ...
     * @throws IgniteCheckedException If failed.
     */
    private String typeName( String cacheName, String typeName) throws IgniteCheckedException {
     ...
     * @return Error bytes.
     */
     private byte[] marshalSchemaError(UUID opId,  SchemaOperationException err) {
        if (err == null)
            return null;
     ...
     * @return Error.
     */
     private SchemaOperationException unmarshalSchemaError( byte[] errBytes) {
        if (errBytes == null)
            return null;
