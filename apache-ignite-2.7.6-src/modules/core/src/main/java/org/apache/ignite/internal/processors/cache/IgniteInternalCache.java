...
public interface IgniteInternalCache<K, V> extends Iterable<Cache.Entry<K, V>> {
     ...
     */
     public V localPeek(K key, CachePeekMode[] peekModes,  IgniteCacheExpiryPolicy plc)
     ...
     * @throws IgniteCheckedException If get operation failed.
     */
    public Map<K, V> getAll( Collection<? extends K> keys) throws IgniteCheckedException;
     ...
     * @return Future for the get operation.
     */
    public IgniteInternalFuture<Map<K, V>> getAllAsync( Collection<? extends K> keys);
     ...
     * @return Future for the get operation.
     */
    public IgniteInternalFuture<Collection<CacheEntry<K, V>>> getEntriesAsync( Collection<? extends K> keys);
     ...
     * @throws IgniteCheckedException If lock acquisition resulted in error.
     */
    public boolean lockAll( Collection<? extends K> keys, long timeout) throws IgniteCheckedException;
     ...
     * @throws IgniteCheckedException If failed.
     */
    public Iterator<Cache.Entry<K, V>> scanIterator(boolean keepBinary,  IgniteBiPredicate<Object, Object> p)
        throws IgniteCheckedException;
     ...
     */
    public void localLoadCache( IgniteBiPredicate<K, V> p,  Object... args)
        throws IgniteCheckedException;
