...
public interface IgniteCacheOffheapManager {
     ...
     * @throws IgniteCheckedException If failed.
     */
     public CacheDataRow mvccRead(GridCacheContext cctx, KeyCacheObject key, MvccSnapshot ver)
        throws IgniteCheckedException;
    ...
    interface CacheDataStore {
         ...
         */
        void init(long size, long updCntr,  Map<Integer, Long> cacheSizes);
         ...
         */
        public int cleanup(GridCacheContext cctx,  List<MvccLinkAwareSearchRow> cleanupRows)
            throws IgniteCheckedException;
         ...
         * @throws IgniteCheckedException If failed.
         */
         GridLongList mvccRemoveNative(GridCacheContext cctx,
                                      boolean primary,
                                      KeyCacheObject key,
                                      MvccSnapshot mvccSnapshot) throws IgniteCheckedException;
