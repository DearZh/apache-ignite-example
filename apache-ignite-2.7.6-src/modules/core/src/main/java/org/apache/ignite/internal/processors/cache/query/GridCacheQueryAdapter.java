...
public class GridCacheQueryAdapter<T> implements CacheQuery<T> {
    ...
    /** {@inheritDoc} */
    @Override public CacheQueryFuture<T> execute( Object... args) {
        return execute0(null, args);
    }

    /** {@inheritDoc} */
    @Override public <R> CacheQueryFuture<R> execute(IgniteReducer<T, R> rmtReducer,  Object... args) {
    ...
    private <R> CacheQueryFuture<R> execute0( IgniteReducer<T, R> rmtReducer,  Object... args) {
    ...
    private static Collection<ClusterNode> nodes(final GridCacheContext<?, ?> cctx,
         final ClusterGroup prj,  final Integer part) throws IgniteCheckedException {
        assert cctx != null;
