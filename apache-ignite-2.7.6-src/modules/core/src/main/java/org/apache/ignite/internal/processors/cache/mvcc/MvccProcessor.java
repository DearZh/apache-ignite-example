...
public interface MvccProcessor extends GridProcessor {
     ...
     * @param activeQueries Active queries.
     */
    void processClientActiveQueries(UUID nodeId,  GridLongList activeQueries);
     ...
     */
     MvccCoordinator currentCoordinator(AffinityTopologyVersion topVer);
     ...
     * @throws ClusterTopologyCheckedException If coordinator doesn't match locked topology or not assigned.
     */
    MvccSnapshot tryRequestSnapshotLocal( IgniteInternalTx tx) throws ClusterTopologyCheckedException;
     ...
     */
    void dumpDebugInfo(IgniteLogger log,  IgniteDiagnosticPrepareContext diagCtx);
