...
public class GridClusterStateProcessor extends GridProcessorAdapter implements IGridClusterStateProcessor, MetastorageLifecycleListener {
    ...
    /** {@inheritDoc} */
    @Override  public IgniteInternalFuture<Boolean> onLocalJoin(DiscoCache discoCache) {
    ...
    /** {@inheritDoc} */
    @Override  public ChangeGlobalStateFinishMessage onNodeLeft(ClusterNode node) {
