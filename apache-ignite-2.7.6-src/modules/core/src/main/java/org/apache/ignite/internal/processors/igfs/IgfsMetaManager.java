...
public class IgfsMetaManager extends IgfsManager {
     ...
     * @throws IgniteCheckedException If failed.
     */
     private IgniteUuid fileId(IgniteUuid parentId, String fileName, boolean skipTx)
     ...
     * @throws IgniteCheckedException If failed.
     */
     public IgfsEntryInfo info( IgniteUuid fileId) throws IgniteCheckedException {
        if (busyLock.enterBusy()) {
            try {
                if (fileId == null)
                    return null;
     ...
     */
    public void unlock(final IgniteUuid fileId, final IgniteUuid lockId, final long modificationTime,
        final boolean updateSpace, final long space,  final IgfsFileAffinityRange affRange)
        throws IgniteCheckedException {
     ...
     */
     private IgfsEntryInfo updatePropertiesNonTx(final IgniteUuid fileId, Map<String, String> props)
        throws IgniteCheckedException {
        assert fileId != null;
     ...
     * @throws IgniteCheckedException If operation failed.
     */
     public IgfsEntryInfo updateProperties(IgniteUuid fileId, Map<String, String> props)
        throws IgniteCheckedException {
        if (busyLock.enterBusy()) {
            try {
                validTxState(false);
     ...
     * @throws IgniteCheckedException If failed.
     */
     public IgfsEntryInfo updateInfo(IgniteUuid fileId,
    ...
    IgfsCreateResult onSuccessCreate(IgfsSecondaryFileSystem fs, IgfsPath path,
        boolean simpleCreate,  final Map<String, String> props, boolean overwrite,
            ...
            try {
                ...
                SynchronizationTask<IgfsCreateResult> task =
                    new SynchronizationTask<IgfsCreateResult>() {
                        ...
                        @Override public IgfsCreateResult onFailure( Exception err)
                            throws IgniteCheckedException {
            ...
            try {
                ...
                SynchronizationTask<IgfsSecondaryInputStreamDescriptor> task =
                    new SynchronizationTask<IgfsSecondaryInputStreamDescriptor>() {
                        ...
                        @Override public IgfsSecondaryInputStreamDescriptor onFailure( Exception err)
                            throws IgniteCheckedException {
     ...
     */
     public IgfsEntryInfo synchronizeFileDual(final IgfsSecondaryFileSystem fs, final IgfsPath path)
        throws IgniteCheckedException {
        assert fs != null;
        assert path != null;
            ...
            try {
                ...
                SynchronizationTask<IgfsEntryInfo> task =
                    new SynchronizationTask<IgfsEntryInfo>() {
                        ...
                        @Override public IgfsEntryInfo onFailure( Exception err) throws IgniteCheckedException {
        ...
        if (busyLock.enterBusy()) {
            try {
                ...
                SynchronizationTask<Boolean> task = new SynchronizationTask<Boolean>() {
                    ...
                    @Override public Boolean onFailure( Exception err) throws IgniteCheckedException {
    ...
    private IgfsEntryInfo synchronize(IgfsSecondaryFileSystem fs,
        ...
        IgfsPath endPath,
        boolean strict,
         Map<IgfsPath, IgfsEntryInfo> created)
        throws IgniteCheckedException
    {
        assert fs != null;
    ...
    private <T> T synchronizeAndExecute(SynchronizationTask<T> task, IgfsSecondaryFileSystem fs, boolean strict,
         Collection<IgniteUuid> extraLockIds, IgfsPath... paths) throws IgniteCheckedException {
        assert task != null;
        assert fs != null;
    ...
    IgfsEntryInfo append(
        ...
        final boolean evictExclude,
         Map<String, String> fileProps) throws IgniteCheckedException {
        validTxState(false);
    ...
    IgfsCreateResult create(
        ...
        final boolean evictExclude,
         ...
         IgfsSecondaryFileSystemCreateContext secondaryCtx) throws IgniteCheckedException {
        validTxState(false);
     ...
     * @throws IgniteCheckedException If failed.
     */
     IgfsPathsCreateResult createDirectory(IgfsPathIds pathIds, Map<IgniteUuid, IgfsEntryInfo> lockInfos,
     ...
     * @throws IgniteCheckedException If failed.
     */
     private IgfsPathsCreateResult createFile(IgfsPathIds pathIds, Map<IgniteUuid, IgfsEntryInfo> lockInfos,
        Map<String, String> dirProps, Map<String, String> fileProps, int blockSize,  IgniteUuid affKey,
        boolean evictExclude,  IgfsSecondaryFileSystemCreateContext secondaryCtx,
         T1<OutputStream> secondaryOutHolder)
        throws IgniteCheckedException{
        // Check if entry we are going to write to is directory.
        if (lockInfos.get(pathIds.lastExistingId()).isFile())
    ...
    private IgfsPathsCreateResult createFileOrDirectory(boolean dir, IgfsPathIds pathIds,
        ...
        int blockSize,  IgniteUuid affKey, boolean evictExclude,
         IgfsSecondaryFileSystemCreateContext secondaryCtx,  T1<OutputStream> secondaryOutHolder)
        throws IgniteCheckedException {
