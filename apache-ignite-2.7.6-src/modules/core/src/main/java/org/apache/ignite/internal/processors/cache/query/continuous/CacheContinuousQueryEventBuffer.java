...
public class CacheContinuousQueryEventBuffer {
     ...
     */
     private Batch initBatch(AffinityTopologyVersion topVer) {
        Batch batch = curBatch.get();
     ...
     * @return New result.
     */
     private Object processPending( Object res, Batch batch, boolean backup) {
    ...
    private class Batch {
         ...
         */
         synchronized TreeMap<Long, CacheContinuousQueryEntry> flushCurrentEntries(
             TreeMap<Long, CacheContinuousQueryEntry> res) {
            if (entries == null)
                return res;
