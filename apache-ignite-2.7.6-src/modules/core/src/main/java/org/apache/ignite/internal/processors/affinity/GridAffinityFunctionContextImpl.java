...
public class GridAffinityFunctionContextImpl implements AffinityFunctionContext {
    ...
    public GridAffinityFunctionContextImpl(List<ClusterNode> topSnapshot, List<List<ClusterNode>> prevAssignment,
        DiscoveryEvent discoEvt, AffinityTopologyVersion topVer, int backups) {
    ...
    /** {@inheritDoc} */
     @Override public List<ClusterNode> previousAssignment(int part) {
    ...
    /** {@inheritDoc} */
     @Override public DiscoveryEvent discoveryEvent() {
        return discoEvt;
    }
