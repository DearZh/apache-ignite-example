...
public class GridJobProcessor extends GridProcessorAdapter {
     ...
     */
    public void cancelJob( final IgniteUuid sesId,  final IgniteUuid jobId, final boolean sys) {
        ...
        try {
            ...
            ctx.collision().onCollision(
                ...
                new AbstractCollection<org.apache.ignite.spi.collision.CollisionJobContext>() {
                    @Override public Iterator<org.apache.ignite.spi.collision.CollisionJobContext> iterator() {
