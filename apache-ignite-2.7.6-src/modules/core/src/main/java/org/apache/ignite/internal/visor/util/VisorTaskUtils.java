...
public class VisorTaskUtils {
     ...
     */
    public static List<VisorLogFile> fileTree(File file, int maxDepth,  FileFilter filter) throws IOException {
     ...
     */
    public static Integer evictionPolicyMaxSize( Factory plc) {
     ...
     * @param msg Message.
     */
    private static void log0( IgniteLogger log, long time, String msg) {
        if (log != null) {
     ...
     */
    public static void logStart( IgniteLogger log, Class<?> clazz, long start) {
     ...
     * @param start Start time.
     */
    public static void logFinish( IgniteLogger log, Class<?> clazz, long start) {
     ...
     */
    public static void logMapped( IgniteLogger log, Class<?> clazz, Collection<ClusterNode> nodes) {
     ...
     */
    public static long log( IgniteLogger log, String msg, Class<?> clazz, long start) {
        final long end = System.currentTimeMillis();
     ...
     * @param msg Message.
     */
    public static void log( IgniteLogger log, String msg) {
     ...
     */
    public static List<Process> startLocalNode( IgniteLogger log, String cfgPath, int nodesToStart,
     ...
     * @throws IOException in case of error.
     */
    public static Process openInConsole( File workFolder, String... args) throws IOException {
     ...
     */
    public static Process openInConsole( File workFolder, Map<String, String> envVars, String... args)
        throws IOException {
    ...
    private static class SortableAddress implements Comparable<SortableAddress> {
        ...
        /** {@inheritDoc} */
        @Override public int compareTo(SortableAddress o) {
