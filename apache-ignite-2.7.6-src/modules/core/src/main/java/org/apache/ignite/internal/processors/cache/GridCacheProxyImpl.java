...
public class GridCacheProxyImpl<K, V> implements IgniteInternalCache<K, V>, Externalizable {
    ...
    /** {@inheritDoc} */
     @Override public Map<K, V> getAllOutTx(Set<? extends K> keys) throws IgniteCheckedException {
        CacheOperationContext prev = gate.enter(opCtx);
    ...
    /** {@inheritDoc} */
    @Override public Map<K, V> getAll( Collection<? extends K> keys) throws IgniteCheckedException {
        CacheOperationContext prev = gate.enter(opCtx);
    ...
    /** {@inheritDoc} */
    @Override public IgniteInternalFuture<Map<K, V>> getAllAsync( Collection<? extends K> keys) {
        CacheOperationContext prev = gate.enter(opCtx);
    ...
    @Override public Iterator<Cache.Entry<K, V>> scanIterator(boolean keepBinary,
         IgniteBiPredicate<Object, Object> p) throws IgniteCheckedException {
        CacheOperationContext prev = gate.enter(opCtx);
    ...
    /** {@inheritDoc} */
     @Override public V localPeek(K key,
    ...
    /** {@inheritDoc} */
     @Override public <T> EntryProcessorResult<T> invoke(
    ...
    /** {@inheritDoc} */
    @Override public boolean lockAll( Collection<? extends K> keys,
