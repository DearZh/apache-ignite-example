...
public class GridDhtAtomicSingleUpdateRequest extends GridDhtAtomicAbstractUpdateRequest {
    ...
    /** {@inheritDoc} */
    @Override  public CacheObject previousValue(int idx) {
        assert idx == 0 : idx;
    ...
    /** {@inheritDoc} */
    @Override  public CacheObject nearValue(int idx) {
        assert idx == 0 : idx;
    ...
    /** {@inheritDoc} */
    @Override  public EntryProcessor<Object, Object, Object> nearEntryProcessor(int idx) {
        assert idx == 0 : idx;
    ...
    /** {@inheritDoc} */
    @Override  public GridCacheVersion conflictVersion(int idx) {
        assert idx == 0 : idx;
    ...
    /** {@inheritDoc} */
    @Override  public Object[] invokeArguments() {
        return null;
    }
     ...
     * @throws IgniteCheckedException if error
     */
    private void finishUnmarshalObject( CacheObject obj, GridCacheContext ctx,
