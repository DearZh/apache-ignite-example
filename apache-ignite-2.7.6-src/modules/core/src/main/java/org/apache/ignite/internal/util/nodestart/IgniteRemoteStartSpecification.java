...
public class IgniteRemoteStartSpecification {
     ...
     */
    public IgniteRemoteStartSpecification( String host, int port,  String uname,
         String passwd,  File key, int nodes,  String igniteHome,
         String cfg,  String script) {
    ...
    public IgniteRemoteStartSpecification( String host, int port,  String uname,
         String passwd,  File key, int nodes,  String igniteHome,
         String cfg,  String script,  IgniteLogger logger) {
        assert port > 0;
        assert nodes > 0;
