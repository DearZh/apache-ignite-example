...
public class BinaryMetadata implements Externalizable {
     ...
     */
    public BinaryMetadata(int typeId, String typeName,  Map<String, BinaryFieldMetadata> fields,
         String affKeyFieldName,  Collection<BinarySchema> schemas, boolean isEnum,
