...
public final class GridJavaProcess {
     ...
     */
    public static GridJavaProcess exec(Class cls, String params,  IgniteLogger log,
         IgniteInClosure<String> printC,  GridAbsClosure procKilledC) throws Exception {
     ...
     */
    public static GridJavaProcess exec(Class cls, String params,  IgniteLogger log,
         IgniteInClosure<String> printC,  GridAbsClosure procKilledC,
         Collection<String> jvmArgs,  String cp) throws Exception {
     ...
     * @throws Exception If any problem occurred.
     */
    public static GridJavaProcess exec(String clsName, String params,  IgniteLogger log,
         IgniteInClosure<String> printC,  GridAbsClosure procKilledC,
         String javaHome,  Collection<String> jvmArgs,  String cp) throws Exception {
    ...
    private class ProcessStreamGrabber extends Thread {
         ...
         * @param printC Optional closure to be called each time wrapped process prints line to system.out or system.err.
         */
        ProcessStreamGrabber(InputStream streamToGrab,  IgniteInClosure<String> printC) {
