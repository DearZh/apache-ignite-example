...
public class MvccQueryTrackerImpl implements MvccQueryTracker {
    ...
    /** {@inheritDoc} */
    @Override public IgniteInternalFuture<MvccSnapshot> requestSnapshot(AffinityTopologyVersion topVer) {
        MvccSnapshot snapshot; MvccSnapshotFuture fut;
    ...
    /** {@inheritDoc} */
    @Override public void requestSnapshot(AffinityTopologyVersion topVer, MvccSnapshotResponseListener lsnr) {
    ...
    /** {@inheritDoc} */
    @Override public IgniteInternalFuture<Void> onDone(GridNearTxLocal tx, boolean commit) {
     ...
     */
    private boolean onResponse0(MvccSnapshot res, MvccSnapshotResponseListener lsnr) {
