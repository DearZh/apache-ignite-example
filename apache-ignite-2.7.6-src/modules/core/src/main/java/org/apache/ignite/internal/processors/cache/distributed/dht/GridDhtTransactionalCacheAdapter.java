...
public abstract class GridDhtTransactionalCacheAdapter<K, V> extends GridDhtCacheAdapter<K, V> {
    ...
    @SuppressWarnings({"RedundantTypeArguments"})
     private GridDhtTxRemote startRemoteTx(UUID nodeId,
     ...
     * @return Lock future.
     */
    public GridDhtFuture<Boolean> lockAllAsyncInternal( Collection<KeyCacheObject> keys,
        long timeout,
        IgniteTxLocalEx txx,
        boolean isInvalidate,
        boolean isRead,
    ...
    public IgniteInternalFuture<GridNearLockResponse> lockAllAsync(
        ...
        final GridNearLockRequest req,
         final CacheEntryPredicate[] filter0) {
