...
public class GridCachePartitionExchangeManager<K, V> extends GridCacheSharedManagerAdapter<K, V> {
    ...
    public GridDhtPartitionsFullMessage createPartitionsFullMessage(
        boolean compress,
        boolean newCntrMap,
         final GridDhtPartitionExchangeId exchId,
     ...
     */
    private void sendLocalPartitions(ClusterNode node,  GridDhtPartitionExchangeId id) {
     ...
     * @param err Error.
     */
    public void onExchangeDone(AffinityTopologyVersion topVer, AffinityTopologyVersion initTopVer,  Throwable err) {
     ...
     */
    public void dumpDebugInfo( GridDhtPartitionsExchangeFuture exchFut) throws Exception {
     ...
     */
    private void dumpPendingObjects( AffinityTopologyVersion exchTopVer,
    ...
    private void dumpDiagnosticInfo(IgniteInternalFuture<?> fut,
         IgniteDiagnosticPrepareContext ctx) {
        U.warn(diagnosticLog, ">>> " + fut);
    ...
    private static class ExchangeFutureSet extends GridListSet<GridDhtPartitionsExchangeFuture> {
        ...
        /** {@inheritDoc} */
         @Override public synchronized GridDhtPartitionsExchangeFuture removex(
