...
public abstract class MessagingListenActor<T> implements IgniteBiPredicate<UUID, T> {
     ...
     */
    protected final void stop( Object respMsg) throws IgniteException {
        keepGoing = false;
     ...
     * @throws IgniteException Thrown in case of any errors.
     */
    protected final void respond( Object respMsg) throws IgniteException {
        checkReversing();
     ...
     * @throws IgniteException Thrown in case of any errors.
     */
    protected final void respond(UUID id,  Object respMsg) throws IgniteException {
        checkReversing();
     ...
     * @throws IgniteException Thrown in case of any errors.
     */
    private void send(UUID nodeId,  Object respMsg) throws IgniteException {
        assert nodeId != null;
