...
public abstract class IgniteTxAdapter extends GridMetadataAwareAdapter implements IgniteInternalTx, Externalizable {
    ...
    private static class TxShadow implements IgniteInternalTx {
        ...
        /** {@inheritDoc} */
         @Override public Object addMeta(int key, Object val) {
            throw new IllegalStateException("Deserialized transaction can only be used as read-only.");
        }

        /** {@inheritDoc} */
         @Override public Object removeMeta(int key) {
            throw new IllegalStateException("Deserialized transaction can only be used as read-only.");
        }

        /** {@inheritDoc} */
         @Override public Object meta(int key) {
            throw new IllegalStateException("Deserialized transaction can only be used as read-only.");
        }
        ...
        /** {@inheritDoc} */
         @Override public GridTuple<CacheObject> peek(GridCacheContext ctx,
            boolean failFast,
            KeyCacheObject key) {
            return null;
        }
        ...
        /** {@inheritDoc} */
         @Override public IgniteInternalFuture<IgniteInternalTx> currentPrepareFuture() {
            return null;
        }
    ...
    private static class TxFinishFuture extends GridFutureAdapter<IgniteInternalTx> {
        ...
        /** {@inheritDoc} */
        @Override public boolean onDone( IgniteInternalTx res,  Throwable err) {
