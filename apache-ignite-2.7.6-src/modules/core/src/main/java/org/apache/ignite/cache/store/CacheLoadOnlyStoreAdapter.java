...
public abstract class CacheLoadOnlyStoreAdapter<K, V, I> implements CacheStore<K, V> {
     ...
     */
    protected abstract Iterator<I> inputIterator( Object... args) throws CacheLoaderException;
     ...
     */
     protected abstract IgniteBiTuple<K, V> parse(I rec,  Object... args);

    /** {@inheritDoc} */
    @Override public void loadCache(IgniteBiInClosure<K, V> c,  Object... args) {
