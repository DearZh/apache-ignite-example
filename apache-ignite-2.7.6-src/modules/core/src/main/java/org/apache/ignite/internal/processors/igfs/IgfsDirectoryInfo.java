...
public class IgfsDirectoryInfo extends IgfsEntryInfo implements Binarylizable {
    ...
    /** {@inheritDoc} */
    @Override public IgfsDirectoryInfo listing( Map<String, IgfsListingEntry> listing) {
     ...
     */
    IgfsDirectoryInfo(IgniteUuid id,  Map<String, IgfsListingEntry> listing,
         Map<String, String> props, long accessTime, long modificationTime) {
    ...
    /** {@inheritDoc} */
    @Override  public IgniteUuid lockId() {
        return null;
    }
