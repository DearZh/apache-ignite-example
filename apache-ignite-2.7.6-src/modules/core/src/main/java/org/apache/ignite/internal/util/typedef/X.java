...
public final class X {
     ...
     */
    public static void println( String s1,  Object... rest) {
     ...
     * @param rest Optional list of objects to print as well.
     */
    public static void printerrln( String s1,  Object... rest) {
        error(s1, rest);
    }
     ...
     * @param rest Optional list of objects to print as well.
     */
    public static void error( String s1,  Object... rest) {
     ...
     * @param rest Optional list of objects to print as well.
     */
    public static void print( String s1,  Object... rest) {
        System.out.print(s1);
     ...
     * @param rest Optional list of objects to print as well.
     */
    public static void printerr( String s1,  Object... rest) {
        System.err.print(s1);
    ...
    @SuppressWarnings({"unchecked"})
     public static <T> T cloneObject( T obj, boolean deep, boolean honorCloneable) {
        if (obj == null)
            return null;
     ...
     */
     private static Object deepClone(Map<Integer, Integer> identityIdxs, List<Object> clones,  Object obj,
     ...
     *      {@code false} otherwise.
     */
    public static boolean hasSuppressed( Throwable t,  Class<? extends Throwable> cls) {
        if (t == null || cls == null)
            return false;
     ...
     */
    public static List<Throwable> getSuppressedList( Throwable t) {
     ...
     */
    public static void waitAll( Iterable<IgniteFuture<?>> futs) {
        if (F.isEmpty(futs))
            return;
