...
public class TxDeadlockDetection {
    ...
    static class TxDeadlockFuture extends GridFutureAdapter<TxDeadlock> {
         ...
         */
        private void map( Set<IgniteTxKey> keys, Map<IgniteTxKey, TxLockList> txLocks) {
        ...
        private void mapTxKeys( Set<IgniteTxKey> txKeys, Map<IgniteTxKey, TxLockList> txLocks) {
        ...
        /** {@inheritDoc} */
        @Override public boolean onDone( TxDeadlock res,  Throwable err) {
