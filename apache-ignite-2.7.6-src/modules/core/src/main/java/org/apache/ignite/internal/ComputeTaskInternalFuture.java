    ...
    public static <R> ComputeTaskInternalFuture<R> finishedFuture(final GridKernalContext ctx,
        ...
        ComputeTaskSession ses = new ComputeTaskSession() {
            ...
            @Override public Collection<ComputeJobSibling> refreshJobSiblings() throws IgniteException {
             ...
             @Override public ComputeJobSibling getJobSibling(IgniteUuid jobId) throws IgniteException {
                return null;
            }

            @Override public void setAttribute(Object key,  Object val) throws IgniteException {
            }
            ...
            @Override public <K, V> boolean waitForAttribute(K key,  V val, long timeout) throws InterruptedException {
                throw new InterruptedException("Session was closed.");
            }
