...
public class GridEventStorageManager extends GridManagerAdapter<EventStorageSpi> {
     ...
     * @param types Additional event types to subscribe listener for.
     */
    public void addDiscoveryEventListener(DiscoveryEventListener lsnr, int type,  int... types) {
        assert lsnr != null;
     ...
     * @param types Additional event types to subscribe listener for.
     */
    private void addEventListener(ListenerWrapper lsnr, int type,  int... types) {
        if (!enterBusy())
            return;
     ...
     * @return Returns {@code true} if removed.
     */
    public boolean removeDiscoveryEventListener(DiscoveryEventListener lsnr,  int... types) {
        assert lsnr != null;
     ...
     * @return Returns {@code true} if removed.
     */
    private boolean removeEventListener(ListenerWrapper lsnr,  int[] types) {
        assert lsnr != null;
     ...
     * @return Event future.
     */
    public <T extends Event> IgniteInternalFuture<T> waitForEvent( final IgnitePredicate<T> p,
         int... types) {
     ...
     */
    private void notifyListeners( Listeners lsnrs, Event evt, Object[] params) {
        assert evt != null;
     ...
     * @param params Event parameters.
     */
    private void notifyListeners( Collection<ListenerWrapper> lsnrs, Event evt, Object[] params) {
