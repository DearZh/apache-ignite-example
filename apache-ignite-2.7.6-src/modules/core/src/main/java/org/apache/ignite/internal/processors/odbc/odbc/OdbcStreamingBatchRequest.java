...
public class OdbcStreamingBatchRequest extends OdbcRequest implements java.lang.Comparable<OdbcStreamingBatchRequest> {
     ...
     * @param order Order.
     */
    public OdbcStreamingBatchRequest( String schema, List<OdbcQuery> queries, boolean last, long order) {
    ...
    /** {@inheritDoc} */
    @Override public int compareTo(OdbcStreamingBatchRequest o) {
