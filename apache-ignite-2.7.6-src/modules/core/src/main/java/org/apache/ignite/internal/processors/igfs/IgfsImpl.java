...
public final class IgfsImpl implements IgfsEx {
    ...
    /** {@inheritDoc} */
    @Override public void globalSampling( final Boolean val) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
    @Override  public Boolean globalSampling() {
    ...
    /** {@inheritDoc} */
    @Override public void mkdirs(final IgfsPath path,  final Map<String, String> props)  {
        A.notNull(path, "path");
    ...
    @Override public IgfsOutputStream create(IgfsPath path, int bufSize, boolean overwrite, int replication,
        long blockSize,  Map<String, String> props) {
    ...
    @Override public IgfsOutputStream create(IgfsPath path, int bufSize, boolean overwrite,
         IgniteUuid affKey, int replication, long blockSize,  Map<String, String> props) {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> R execute(IgfsTask<T, R> task,  IgfsRecordResolver rslvr,
        Collection<IgfsPath> paths,  T arg) {
        try {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> IgniteFuture<R> executeAsync(IgfsTask<T, R> task,  IgfsRecordResolver rslvr,
        Collection<IgfsPath> paths,  T arg) throws IgniteException {
        return createFuture(executeAsync0(task, rslvr, paths, arg));
    }

    /** {@inheritDoc} */
    @Override public <T, R> R execute(IgfsTask<T, R> task,  IgfsRecordResolver rslvr,
        Collection<IgfsPath> paths, boolean skipNonExistentFiles, long maxRangeLen,  T arg) {
        try {
    ...
    @Override public <T, R> R execute(Class<? extends IgfsTask<T, R>> taskCls,
         IgfsRecordResolver rslvr, Collection<IgfsPath> paths,  T arg) {
        try {
    ...
    @Override public <T, R> IgniteFuture<R> executeAsync(Class<? extends IgfsTask<T, R>> taskCls,
         IgfsRecordResolver rslvr, Collection<IgfsPath> paths,  T arg) throws IgniteException {
        return createFuture(executeAsync0(taskCls, rslvr, paths, arg));
    }

    /** {@inheritDoc} */
    @Override public <T, R> R execute(Class<? extends IgfsTask<T, R>> taskCls,
         IgfsRecordResolver rslvr, Collection<IgfsPath> paths, boolean skipNonExistentFiles,
        long maxRangeSize,  T arg) {
        try {
    ...
    /** {@inheritDoc} */
    @Override public <T, R> IgniteFuture<R> executeAsync(Class<? extends IgfsTask<T, R>> taskCls,
         IgfsRecordResolver rslvr, Collection<IgfsPath> paths, boolean skipNonExistentFiles, long maxRangeLen,
         T arg) throws IgniteException {
     ...
     */
    <T, R> IgniteInternalFuture<R> executeAsync0(IgfsTask<T, R> task,  IgfsRecordResolver rslvr,
        Collection<IgfsPath> paths,  T arg) {
    ...
    private static class IgfsGlobalSpaceTask extends ComputeTaskSplitAdapter<Object, IgniteBiTuple<Long, Long>> {
         ...
         */
        private IgfsGlobalSpaceTask( String igfsName) {
            ...
            for (int i = 0; i < gridSize; i++) {
                res.add(new ComputeJobAdapter() {
                    ...
                    private Ignite g;
                     ...
                     @Override public IgniteBiTuple<Long, Long> execute() {
        ...
        /** {@inheritDoc} */
         @Override public IgniteBiTuple<Long, Long> reduce(List<ComputeJobResult> results) {
            long used = 0;
            long max = 0;
