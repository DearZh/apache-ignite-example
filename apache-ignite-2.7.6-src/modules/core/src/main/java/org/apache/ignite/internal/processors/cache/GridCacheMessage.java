...
public abstract class GridCacheMessage implements Message {
     ...
     */
    protected final void prepareObject( Object o, GridCacheContext ctx) throws IgniteCheckedException {
     ...
     * @throws IgniteCheckedException If failed.
     */
    protected final void prepareObject( Object o, GridCacheSharedContext ctx) throws IgniteCheckedException {
     ...
     * @throws IgniteCheckedException If failed.
     */
     protected final byte[][] marshalInvokeArguments( Object[] args, GridCacheContext ctx)
        throws IgniteCheckedException {
        assert ctx != null;
     ...
     * @throws IgniteCheckedException If failed.
     */
     protected final Object[] unmarshalInvokeArguments( byte[][] byteCol,
        GridCacheSharedContext ctx,
        ClassLoader ldr) throws IgniteCheckedException {
        assert ldr != null;
        assert ctx != null;
     ...
     * @throws IgniteCheckedException If failed.
     */
     protected List<byte[]> marshalCollection( Collection<?> col,
    ...
    public final void prepareMarshalCacheObjects( List<? extends CacheObject> col,
        GridCacheContext ctx) throws IgniteCheckedException {
        if (col == null)
            return;
     ...
     * @throws IgniteCheckedException If failed.
     */
    protected final void prepareMarshalCacheObjects( Collection<? extends CacheObject> col,
        GridCacheContext ctx) throws IgniteCheckedException {
        if (col == null)
            return;
     ...
     */
    @SuppressWarnings("ForLoopReplaceableByForEach")
    public final void finishUnmarshalCacheObjects( List<? extends CacheObject> col,
     ...
     * @throws IgniteCheckedException If failed.
     */
    protected final void finishUnmarshalCacheObjects( Collection<? extends CacheObject> col,
        GridCacheContext ctx,
        ClassLoader ldr)
        throws IgniteCheckedException
    {
     ...
     * @throws IgniteCheckedException If failed.
     */
     protected <T> List<T> unmarshalCollection( Collection<byte[]> byteCol,
