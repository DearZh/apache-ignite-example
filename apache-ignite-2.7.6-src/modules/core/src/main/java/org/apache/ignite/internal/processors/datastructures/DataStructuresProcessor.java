...
public final class DataStructuresProcessor extends GridProcessorAdapter implements IgniteChangeGlobalStateSupport {
     ...
     */
    public static boolean isReservedGroup( String grpName) {
     ...
     * @throws IgniteCheckedException If failed.
     */
     private <T extends GridCacheRemovable> T getAtomic(final AtomicAccessor<T> c,
         AtomicConfiguration cfg,
        final String name,
     ...
     * @throws IgniteCheckedException If removing failed.
     */
    final void removeAtomicLong(final String name,  final String grpName) throws IgniteCheckedException {
    ...
    private <T> void removeDataStructure(
         final IgnitePredicateX<AtomicDataStructureValue> pred,
        final String name,
        String grpName,
        final DataStructureType type,
         final IgniteInClosureX<T> afterRmv
    ) throws IgniteCheckedException {
        assert name != null;
        assert grpName != null;
        assert type != null;
     ...
     * @throws IgniteCheckedException If removing failed.
     */
    final void removeAtomicReference(final String name,  final String grpName) throws IgniteCheckedException {
     ...
     */
    @SuppressWarnings("unchecked")
    public final <T, S> IgniteAtomicStamped<T, S> atomicStamped(final String name,  AtomicConfiguration cfg,
     ...
     */
    @SuppressWarnings("unchecked")
    public final <T> IgniteQueue<T> queue(final String name,  final String grpName, int cap,
         final CollectionConfiguration cfg)
        throws IgniteCheckedException {
        A.notNull(name, "name");
     ...
     * @throws IgniteCheckedException If failed.
     */
     private <T> T getCollection(final IgniteClosureX<GridCacheContext, T> c,
     ...
     * @throws IgniteCheckedException If operation failed.
     */
    public IgniteSemaphore semaphore(final String name,  AtomicConfiguration cfg, final int cnt,
     ...
     * @throws IgniteCheckedException If operation failed.
     */
    public IgniteLock reentrantLock(final String name,  AtomicConfiguration cfg, final boolean failoverSafe,
     ...
     */
    @SuppressWarnings("unchecked")
     public <T> IgniteSet<T> set(final String name,  final String grpName,  final CollectionConfiguration cfg)
        throws IgniteCheckedException {
        A.notNull(name, "name");
     ...
     */
    @SuppressWarnings("unchecked")
     private <R> R cast( Object obj, Class<R> cls) throws IgniteCheckedException {
        if (obj == null)
            return null;
