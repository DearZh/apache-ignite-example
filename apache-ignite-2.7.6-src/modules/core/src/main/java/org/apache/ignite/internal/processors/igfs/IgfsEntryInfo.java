...
public abstract class IgfsEntryInfo implements Externalizable {
     ...
     */
    protected IgfsEntryInfo(IgniteUuid id,  Map<String, String> props, long accessTime,
     ...
     * @return Updated file info.
     */
    public abstract IgfsEntryInfo listing( Map<String, IgfsListingEntry> listing);
     ...
     * @return Updated file info.
     */
    public IgfsEntryInfo properties( Map<String, String> props) {
