...
public class BinaryObjectOffheapImpl extends BinaryObjectExImpl implements Externalizable, CacheObject {
    ...
    /** {@inheritDoc} */
     @Override public BinaryType rawType() throws BinaryObjectException {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
     @Override public <F> F field(int fieldId) throws BinaryObjectException {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
     @Override public <F> F fieldByOrder(int order) {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
     @Override protected <F> F field(BinaryReaderHandles rCtx, String fieldName) {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
     @Override public <T> T value(CacheObjectValueContext ctx, boolean cpy) {
        return (T)deserializeValue();
    }
     ...
     * @return Reader.
     */
    private BinaryReaderExImpl reader( BinaryReaderHandles rCtx, boolean forUnmarshal) {
        BinaryOffheapInputStream stream = new BinaryOffheapInputStream(ptr, size, false);
