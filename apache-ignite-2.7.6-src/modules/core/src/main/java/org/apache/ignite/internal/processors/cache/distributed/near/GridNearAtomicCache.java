...
public class GridNearAtomicCache<K, V> extends GridNearCacheAdapter<K, V> {
     ...
     */
     public List<KeyCacheObject> processDhtAtomicUpdateRequest(
        UUID nodeId,
    ...
    /** {@inheritDoc} */
    @Override public V getAndPut(K key, V val,  CacheEntryPredicate filter) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
    @Override public boolean remove(K key,  CacheEntryPredicate filter) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
    @SuppressWarnings("unchecked")
    @Override public IgniteInternalFuture<Boolean> removeAsync(K key,  CacheEntryPredicate filter) {
