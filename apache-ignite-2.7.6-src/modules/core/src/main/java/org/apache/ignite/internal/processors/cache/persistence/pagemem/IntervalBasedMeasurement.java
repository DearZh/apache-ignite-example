...
class IntervalBasedMeasurement {
     ...
     */
    private long calcSpeed( MeasurementInterval interval, long curNanoTime) {
        long nanosPassed = 0;
        long opsDone = 0;
     ...
     */
    private boolean isOutdated( final MeasurementInterval interval, long curNanoTime) {
        if (interval == null)
            return true;
     ...
     */
    private long avgMeasurementWithHistorical( MeasurementInterval interval, long curNanoTime) {
        long cnt = 0;
        long sum = 0;
        if (!isOutdated(interval, curNanoTime)) {
