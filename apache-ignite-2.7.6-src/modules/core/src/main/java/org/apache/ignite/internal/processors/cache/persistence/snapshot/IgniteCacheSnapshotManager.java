...
public class IgniteCacheSnapshotManager<T extends SnapshotOperation> extends GridCacheSharedManagerAdapter implements IgniteChangeGlobalStateSupport {
     ...
     */
     public IgniteInternalFuture tryStartLocalSnapshotOperation(
             DiscoveryEvent discoveryEvent, AffinityTopologyVersion topVer
     ...
     */
     public IgniteInternalFuture startLocalSnapshotOperation(
