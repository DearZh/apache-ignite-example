...
public class BinaryMarshaller extends AbstractNodeNameAwareMarshaller {
    ...
    /** {@inheritDoc} */
    @Override protected byte[] marshal0( Object obj) throws IgniteCheckedException {
        return impl.marshal(obj, false);
    }

    /** {@inheritDoc} */
    @Override protected void marshal0( Object obj, OutputStream out) throws IgniteCheckedException {
    ...
    /** {@inheritDoc} */
    @Override protected <T> T unmarshal0(byte[] bytes,  ClassLoader clsLdr) throws IgniteCheckedException {
        return impl.deserialize(bytes, clsLdr);
    }

    /** {@inheritDoc} */
    @Override protected <T> T unmarshal0(InputStream in,  ClassLoader clsLdr) throws IgniteCheckedException {
