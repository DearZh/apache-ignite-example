...
public class GridContinuousProcessor extends GridProcessorAdapter {
     ...
     * @throws IgniteCheckedException In case of error.
     */
    private void sendWithRetries(UUID nodeId, GridContinuousMessage msg,  Object orderedTopic,
     ...
     * @throws IgniteCheckedException In case of error.
     */
    private void sendWithRetries(ClusterNode node, GridContinuousMessage msg,  Object orderedTopic,
        IgniteInClosure<IgniteException> ackC) throws IgniteCheckedException {
        assert node != null;
        assert msg != null;
    ...
    private void sendWithRetries(Collection<? extends ClusterNode> nodes, GridContinuousMessage msg,
         Object orderedTopic, IgniteInClosure<IgniteException> ackC) throws IgniteCheckedException {
    ...
    static class LocalRoutineInfo implements Serializable {
         ...
         * @param autoUnsubscribe Automatic unsubscribe flag.
         */
        LocalRoutineInfo( IgnitePredicate<ClusterNode> prjPred,
            GridContinuousHandler hnd,
            int bufSize,
            long interval,
            boolean autoUnsubscribe)
