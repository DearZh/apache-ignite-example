...
public class VisorViewCacheTask extends VisorOneNodeTask<VisorViewCacheTaskArg, VisorViewCacheTaskResult> {
    ...
    private static class VisorViewCacheJob extends VisorJob<VisorViewCacheTaskArg, VisorViewCacheTaskResult> {
         ...
         * @param debug Debug.
         */
        protected VisorViewCacheJob( VisorViewCacheTaskArg arg, boolean debug) {
            super(arg, debug);
        }

        /** {@inheritDoc} */
        @Override protected VisorViewCacheTaskResult run( VisorViewCacheTaskArg arg) throws IgniteException {
            try {
