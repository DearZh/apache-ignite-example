...
public interface MvccQueryTracker {
     ...
     * @return Future to wait for result.
     */
    public IgniteInternalFuture<MvccSnapshot> requestSnapshot(AffinityTopologyVersion topVer);
     ...
     */
    public void requestSnapshot(AffinityTopologyVersion topVer, MvccSnapshotResponseListener lsnr);
     ...
     */
     public IgniteInternalFuture<Void> onDone(GridNearTxLocal tx, boolean commit);
