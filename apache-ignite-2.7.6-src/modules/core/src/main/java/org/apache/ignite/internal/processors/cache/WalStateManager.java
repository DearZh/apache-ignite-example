...
public class WalStateManager extends GridCacheSharedManagerAdapter {
     ...
     * @param res Result.
     */
    private static void complete( GridFutureAdapter<Boolean> userFut, boolean res) {
        if (userFut != null)
            userFut.onDone(res);
    }
     ...
     * @param errMsg Error message.
     */
    private static void completeWithError( GridFutureAdapter<Boolean> userFut, String errMsg) {
        if (userFut != null)
