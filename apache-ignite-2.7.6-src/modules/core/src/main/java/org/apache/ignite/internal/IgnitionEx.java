...
public class IgnitionEx {
     ...
     * @return Grid state.
     */
    public static IgniteState state( String name) {
     ...
     *      not found).
     */
    public static boolean stop( String name, boolean cancel, boolean stopNotStarted) {
        IgniteNamedInstance grid = name != null ? grids.get(name) : dfltGrid;
     ...
     */
    public static boolean stop( String name, boolean cancel, boolean stopNotStarted, long timeoutMs) {
     ...
     *      also if default grid has already been started.
     */
    public static Ignite start( GridSpringResourceContext springCtx) throws IgniteCheckedException {
     ...
     *      also if named grid has already been started.
     */
    public static Ignite start(IgniteConfiguration cfg,  GridSpringResourceContext springCtx) throws IgniteCheckedException {
        A.notNull(cfg, "cfg");
     ...
     *      also if named grid has already been started.
     */
    public static T2<Ignite, Boolean> start(IgniteConfiguration cfg,  GridSpringResourceContext springCtx, boolean failIfStarted) throws IgniteCheckedException {
        A.notNull(cfg, "cfg");
     ...
     */
    public static Ignite start( String springCfgPath) throws IgniteCheckedException {
     ...
     *      been started or Spring XML configuration file is invalid.
     */
    public static Ignite start( String springCfgPath,  String igniteInstanceName)
     ...
     */
    public static Ignite start(String springCfgPath,  String igniteInstanceName,
         GridSpringResourceContext springCtx,  ClassLoader ldr) throws IgniteCheckedException {
     ...
     *      been started or Spring XML configuration file is invalid.
     */
    public static Ignite start(URL springCfgUrl,  ClassLoader ldr) throws IgniteCheckedException {
     ...
     *      been started or Spring XML configuration file is invalid.
     */
    public static Ignite start(URL springCfgUrl,  String igniteInstanceName,
         GridSpringResourceContext springCtx,  ClassLoader ldr) throws IgniteCheckedException {
     ...
     *      been started or Spring XML configuration file is invalid.
     */
    public static Ignite start(InputStream springCfgStream,  String igniteInstanceName,
         GridSpringResourceContext springCtx,  ClassLoader ldr) throws IgniteCheckedException {
     ...
     *      initialized or grid instance was stopped or was not started.
     */
    public static Ignite grid( String name) throws IgniteIllegalStateException {
        IgniteNamedInstance grid = name != null ? grids.get(name) : dfltGrid;
     ...
     */
    public  static IgniteKernal gridx( String name) {
        IgniteNamedInstance grid = name != null ? grids.get(name) : dfltGrid;
     ...
     */
    private static void notifyStateChange( String igniteInstanceName, IgniteState state) {
    ...
    private static final class GridStartContext {
         ...
         * @param springCtx Optional Spring application context.
         */
        GridStartContext(IgniteConfiguration cfg,  URL cfgUrl,  GridSpringResourceContext springCtx) {
            assert(cfg != null);
    ...
    private static final class IgniteNamedInstance {
         ...
         */
        IgniteNamedInstance( String name) {
            this.name = name;
        }
        ...
        private IgniteLogger initLogger( IgniteLogger cfgLog, UUID nodeId, String workDir)
            throws IgniteCheckedException {
            try {
