 ...
 *             println("foo")
 *     }
 *     def foo( args: Symbol*) = foo(visor.flatSymbols(args: _*))
 * }
...
object visor extends VisorTag {
     ...
     */
    def mfind( v: String): Seq[(String, String)] = mem.filter(t => t._2 == v).toSeq
    ...
    /**
      ...
      * @param v Value to find by.
      */
    def mfindHead( v: String): Option[(String, String)] =
    ...
    def addHelp(
        name: String,
        shortInfo: String,
         longInfo: Seq[String] = null,
         aliases: Seq[String] = Seq.empty,
        spec: Seq[String],
         args: Seq[(String, AnyRef)] = null,
        examples: Seq[(String, AnyRef)],
        emptyArgs: () => Unit,
        withArgs: (String) => Unit) {
        assert(name != null)
     ...
     */
    def parseArgs( args: String): ArgList = {
     ...
     */
    def hasArgValue( v: String, args: ArgList): Boolean = {
        assert(args != null)
     ...
     * @param args Command argument list.
     */
    def hasArgName( n: String, args: ArgList): Boolean = {
        assert(args != null)
     ...
     */
     def argValue(n: String, args: ArgList): Option[String] = {
        assert(n != null && args != null)
     ...
     */
    def safe( a: Any, dflt: Any = NA): String = {
        assert(dflt != null)
     ...
     */
    private def has[T]( s: Seq[T]): Boolean = {
        s != null && s.nonEmpty
    }
