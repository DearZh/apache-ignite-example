...
public class UploadBenchmarkArguments implements StreamerParams {
     ...
     */
    @Override  public Integer streamerPerNodeBufferSize() {
     ...
     */
    @Override  public Integer streamerPerNodeParallelOperations() {
     ...
     */
    @Override  public Integer streamerLocalBatchSize() {
     ...
     */
    @Override  public Boolean streamerAllowOverwrite() {
