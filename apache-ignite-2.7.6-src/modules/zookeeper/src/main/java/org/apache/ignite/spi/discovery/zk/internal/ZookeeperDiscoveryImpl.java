...
public class ZookeeperDiscoveryImpl {
     ...
     * @throws InterruptedException If interrupted.
     */
    private void joinTopology( ZkRuntimeState prevState) throws InterruptedException {
     ...
     * @throws InterruptedException If interrupted.
     */
    private void startJoin(ZkRuntimeState rtState,  ZkRuntimeState prevState, final byte[] joinDataBytes)
    ...
    private void newClusterStarted( ZkDiscoveryEventsData prevEvts) throws Exception {
        assert !locNode.isClient() : locNode;
     ...
     * @throws Exception If failed.
     */
    private void deleteAliveNodes( GridLongList internalIds) throws Exception {
        if (internalIds == null)
            return;
...
//        }
     ...
     * @throws Exception If failed.
     */
     private DiscoverySpiCustomMessage handleProcessedCustomEvent(String ctx, ZkDiscoveryCustomEventData evtData)
        throws Exception {
        if (log.isDebugEnabled())
