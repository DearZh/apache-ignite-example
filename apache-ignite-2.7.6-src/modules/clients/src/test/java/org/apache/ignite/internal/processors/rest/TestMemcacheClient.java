...
final class TestMemcacheClient {
     ...
     * @throws IgniteCheckedException In case of error.
     */
    public <K, V> boolean cacheAdd( String cacheName, K key, V val)
        throws IgniteCheckedException {
        assert key != null;
        assert val != null;
     ...
     * @throws IgniteCheckedException In case of error.
     */
    public <K> long increment(K key,  Long init, long incr)
        throws IgniteCheckedException {
        assert key != null;
     ...
     * @throws IgniteCheckedException In case of error.
     */
    public <K> long decrement(K key,  Long init, long decr)
        throws IgniteCheckedException {
        assert key != null;
     ...
     * @throws IgniteCheckedException In case of error.
     */
    public <K> boolean cacheAppend( String cacheName, K key, String val)
        throws IgniteCheckedException {
        assert key != null;
        assert val != null;
     ...
     * @throws IgniteCheckedException In case of error.
     */
    public <K> boolean cachePrepend( String cacheName, K key, String val)
        throws IgniteCheckedException {
        assert key != null;
        assert val != null;
     ...
     * @throws IgniteCheckedException In case of error.
     */
    public Data encode( Object obj) throws IgniteCheckedException {
        if (obj == null)
    ...
    private static class Response {
         ...
         */
        Response(int opaque, boolean success,  Object key,  Object obj) {
            assert opaque >= 0;
