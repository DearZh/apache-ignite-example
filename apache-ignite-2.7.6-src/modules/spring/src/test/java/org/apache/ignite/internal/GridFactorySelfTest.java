...
public class GridFactorySelfTest extends GridCommonAbstractTest {
     ...
     */
    private void checkLifecycleBeans( String igniteInstanceName) throws Exception {
     ...
     * @throws Exception If failed.
     */
    private void checkConcurrentStartStop( final String igniteInstanceName) throws Exception {
