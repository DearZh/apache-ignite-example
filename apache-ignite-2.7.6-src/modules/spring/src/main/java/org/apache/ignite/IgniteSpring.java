...
public class IgniteSpring {
     ...
     */
    public static Ignite start( ApplicationContext springCtx) throws IgniteCheckedException {
     ...
     */
    public static Ignite start(IgniteConfiguration cfg,  ApplicationContext springCtx) throws IgniteCheckedException {
     ...
     */
    public static Ignite start(String springCfgPath,  ApplicationContext springCtx) throws IgniteCheckedException {
     ...
     *      been started or Spring XML configuration file is invalid.
     */
    public static Ignite start(URL springCfgUrl,  ApplicationContext springCtx) throws IgniteCheckedException {
