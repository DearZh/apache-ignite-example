...
public abstract class HibernateAbstractRegionAccessStrategy implements RegionAccessStrategy {
    ...
    /** {@inheritDoc} */
     @Override public Object get(SessionImplementor ses, Object key, long txTs) throws CacheException {
        return stgy.get(key);
    }
    ...
    /** {@inheritDoc} */
     @Override public SoftLock lockItem(SessionImplementor ses, Object key, Object ver) throws CacheException {
        stgy.lock(key);
    ...
    /** {@inheritDoc} */
     @Override public SoftLock lockRegion() throws CacheException {
        stgy.lockRegion();
