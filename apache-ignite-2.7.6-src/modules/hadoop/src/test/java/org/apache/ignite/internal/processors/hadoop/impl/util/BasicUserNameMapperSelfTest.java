...
public class BasicUserNameMapperSelfTest extends GridCommonAbstractTest {
     ...
     * @throws Exception If failed.
     */
    private void checkNullOrEmptyMappings( Map<String, String> map) throws Exception {
     ...
     * @return Mapper.
     */
    private BasicUserNameMapper create( Map<String, String> dictionary, boolean useDfltUsrName,
         String dfltUsrName) {
