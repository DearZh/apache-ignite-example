...
public abstract class HadoopV2Task extends HadoopTask {
     ...
     * @throws InterruptedException In case of interrupt.
     */
    protected void setup( OutputFormat outputFormat) throws IOException, InterruptedException {
     ...
     * @throws InterruptedException In case of interrupt.
     */
    protected void commit( OutputFormat outputFormat) throws IgniteCheckedException, IOException, InterruptedException {
        if (hadoopCtx.writer() != null) {
            assert outputFormat != null;
     ...
     * @param outputFormat Output format.
     */
    protected void abort( OutputFormat outputFormat) {
        if (hadoopCtx.writer() != null) {
            assert outputFormat != null;
