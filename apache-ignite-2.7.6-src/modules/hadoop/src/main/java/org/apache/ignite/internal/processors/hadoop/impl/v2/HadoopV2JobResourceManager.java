...
class HadoopV2JobResourceManager {
     ...
     */
    private void processFiles(File jobLocDir,  Object[] files, boolean download, boolean extract,
         Collection<URL> clsPathUrls,  String rsrcNameProp) throws IOException {
